# 2025-2 Molly O'Shea Sourcery

| Company Name | Sector | Key Leadership | Total Funding Raised | Annual Revenue | Core Mission | Strategic Partners and Investors |
| :---- | :---- | :---- | :---- | :---- | :---- | :---- |
| **OpenAI** | Artificial Intelligence | [Sam Altman](https://en.wikipedia.org/wiki/Sam_Altman) (CEO), [Greg Brockman](https://www.linkedin.com/in/thegdb) | $13B+ (Inferred) | Not in source | To build AGI and push the frontier of AI research. | Thrive Capital, Microsoft, Nvidia, Apple, Altimeter |
...
| **AppLovin** | Digital Advertising / Mobile Gaming | [Adam Foroughi](https://www.linkedin.com/in/adamforoughi) (CEO) | Not in source | Not in source | To drive mobile gaming ads using AI-powered engines. | Coatue |
| **Opendoor** | Real Estate, Tech, and Fintech | [Kaz Nejatian](https://ca.linkedin.com/in/kasranejatian) (CEO), [Keith Rabois](https://www.linkedin.com/in/keith) (Co-founder), [Eric Wu](https://www.linkedin.com/in/ericwu01/) (Co-founder), [Ian Wong](https://www.linkedin.com/in/ian-wong/) (Co-founder/CTO) | Not in source | Not in source | To completely transform residential real estate in the United States, propel home ownership, and embrace retail as a movement. | Keith Rabois, Eric Wu, Khosla Ventures, Paul Diversa |
...
| **Joby Aviation** | Transportation / eVTOL | [JoeBen Bevirt](https://www.linkedin.com/in/joeben-bevirt-639451) (Founder/CEO), [Eric Allison](https://www.linkedin.com/in/eric-m-allison) | $500M+ | Not in source | To be the air taxi provider and pioneer electric vertical takeoff and landing aircraft manufacturing in America. | Toyota Motor Corporation, Uber, Delta, Reinvent Technology Partners |
...
| **Cursor** | AI Software / Developer Tools | [Michael Truell](https://www.linkedin.com/in/michael-t-5b1bbb122/) (CEO), [Aman Sanger](https://www.linkedin.com/in/aman-sanger-482243171) | Not in source | Hundreds of millions (Run rate) | To be the ultimate AI pair programmer and automate coding drudgery. | Thrive Capital, OpenAI |
...
| **Allen Control Systems** | Defense Technology | [Steven Simoni](https://www.linkedin.com/in/stevensimoni), [Luke Allen](https://www.linkedin.com/in/lukeallen1138) (Co-founder) | $43M | Not in source | Building AI machine guns (Bullfrog) specifically designed to neutralize drone threats. | Craft Ventures, Inspired Capital |
...
| **Scale AI** | AI Infrastructure / Data Labeling | [Alexandr Wang](https://www.linkedin.com/in/alexandrwang) | Not in source | Not in source | Accelerate the development of AI applications. | Brex |
| **Wiz** | Cloud Security | [Assaf Rappaport](https://www.linkedin.com/in/assafrappaport) (CEO) | Not in source | Not in source | Securing cloud software for the world via a developer-friendly platform. | Thrive Capital, Sequoia, Index, Cyberstarts |
| **Archer Aviation** | Aviation / eVTOL | [Adam Goldstein](https://www.linkedin.com/in/adam-goldstein-7b662121) (CEO/Founder) | Not in source | Not in source | To build the next generation of aviation and vertical lift aircraft to solve urban traffic problems. | Anduril, United Airlines, Mubadala, US Department of Defense |
| **Regent** | Maritime / Defense | [Billy Thalheimer](https://www.linkedin.com/in/williamthalheimer) (CEO/Co-founder) | Not in source | Not in source | To bring high-speed rail level speed and cost to coastal transportation through electric seagliders. | US Marine Corps, SOCOM, US Coast Guard |
| **Tusk Strategies** | Venture Capital / Consulting | [Bradley Tusk](https://www.linkedin.com/in/btusk) (Founder) | Not in source | Not in source | To provide regulatory and political advisory services for high-growth startups in exchange for equity. | Uber, Clear, FanDuel, Coinbase, Circle, Elma, Lemonade |
| **Epirus** | Defense Technology | [Andy Lowry](https://www.linkedin.com/in/andylowery) (CEO) | Not in source | Not in source | Developing software-defined directed energy weapons to counter drone swarms. | General Dynamics |
| **Flock Safety** | Public Safety / AI | [Garrett Langley](https://www.linkedin.com/in/glangley) (CEO) | Not in source | Not in source | To reduce crime and improve public safety through AI-powered objective policing. | Andreessen Horowitz (a16z) |
| **Radiant Nuclear** | Energy | [Doug Bernauer](https://www.linkedin.com/in/doug-bernauer) (CEO/Co-founder) | Not in source | Not in source | To build a transportable nuclear reactor that fits in a shipping container for clean energy. | Andreessen Horowitz (a16z) |
| **Kalshi** | Finance / Prediction Markets | [Tarek Mansour](https://www.linkedin.com/in/mansourtarek) (CEO), Luana Lopes Lara (Co-founder) | Not in source | Not in source | To be the first regulated events marketplace and exchange. | Sequoia Capital, CFTC (Regulator) |
| **DoorDash** | Technology / Logistics | [Tony Xu](https://www.linkedin.com/in/xutony/) (CEO), [Alfred Lin](https://www.linkedin.com/in/linalfred) (Board Member) | Not in source | Not in source | To be the most efficient food delivery and logistics engine. | Sequoia Capital |
| **Citadel Securities** | Financial Services | [Ken Griffin](https://www.linkedin.com/in/ken-griffin) | Not in source | Not in source | Market making and utilizing technology/math for risk calculation and arbitrage. | Sequoia Capital |
| **Nudge** | Neurotechnology / Health | [Jeremy Barenholtz](https://www.linkedin.com/in/human-brain), [Fred Ehrsam](https://www.linkedin.com/in/fredehrsam) | Not in source | Not in source | Using non-invasive ultrasound to stimulate brain activity and cure neurological illnesses. | Thrive Capital |
| **Thrive Capital** | Venture Capital | [Josh Kushner](https://www.linkedin.com/in/joshua-kushner-711b45230) (Founder), [Philip Clark](https://www.linkedin.com/in/philip-clark-883a41126/) | $25B AUM | Not in source | To be a partner to generational technology companies. | Not in source |
| **Founders Podcast** | Media / Podcasting | [David Senra](https://www.linkedin.com/in/davidsenra) (Founder) | Not in source | Not in source | To provide high quality business education through a lifelong study of history's greatest entrepreneurs. | Dell, Colossus, Huberman Lab |
| **OYO Rooms** | Hospitality | [Ritesh Agarwal](https://in.linkedin.com/in/riteshagar) (Founder) | Not in source | Not in source | To build a large-scale hotel chain, starting as an Airbnb clone in India. | Thiel Fellowship |
| **Galvanick** | Cybersecurity / Industrial OT | [Joshua Steinman](https://www.linkedin.com/in/jmsteinman) (Founder) | Not in source | Not in source | Protecting critical industrial infrastructure and the defense industrial base from cyber attacks. | Not in source |
| **Dirac, Inc.** | Manufacturing Tech | [Philip Aronshtein](https://www.linkedin.com/in/fila/) (Founder) | Not in source | Not in source | Driving America towards context-aware production planning via an automated work instruction platform (BuildOS). | Not in source |

# 2025-08-29

# **Thiel Fellowship: Impact, Philosophy, and Selection Methodology**

## **Executive Summary**

This document provides a comprehensive synthesis of the origins, evolution, and cultural impact of the **Thiel Fellowship**, based on insights from [Danielle Strachman](https://www.linkedin.com/in/daniellestrachman), a founding member of the fellowship team and co-founder of **1517 Fund**.

The **Thiel Fellowship**, launched in 2010 by [Peter Thiel](https://www.linkedin.com/in/peterthiel), fundamentally challenged the traditional educational path by offering young people $100,000 to drop out of school and pursue independent projects. Since its inception, the fellowship has catalyzed over $550 billion in value creation, producing industry defining entities such as **Ethereum** and **Figma**. The program operates not as a startup incubator, but as a diverse project engine supporting researchers, non-profit founders, and entrepreneurs. Its lasting legacy includes the normalization of gap years, the promotion of direct patronage for individuals, and a shift in Silicon Valley culture toward taking teenage founders seriously.

## **Program Structure and Founding Principles**

The **Thiel Fellowship** was conceived as a radical intervention in the higher education bubble. The core mission was encapsulated in the motto: "Some ideas can't wait."

### **Core Mechanics**

* **Target Demographic:** Originally focused on individuals aged 19 and under (now 22 and under).  
* **Grant Structure:** Fellows receive $100,000 over two years.  
* **Participation Requirements:** Fellows must not be enrolled in school, have a degree, or be participating in an internship. They must work on their own projects.  
* **Diverse Scope:** The program was designed to support projects rather than just startups, including mathematicians, researchers, and non-profit leaders.

### **Educational Pedagogy**

The fellowship’s approach was heavily influenced by homeschooling philosophy:

* **Individualization:** Catering to the specific needs of the fellow rather than a uniform curriculum.  
* **Socratic Dialogue:** Using questioning to help fellows identify roadblocks and set goals.  
* **The Buffet Table Model:** Providing optional resources (e.g., master negotiators or technical workshops) that fellows could access, if and when, they felt their house was on fire.

## **Success Stories and Value Creation**

The fellowship’s impact is characterized by a hit rate of approximately 5.9%, with several outsized successes that have shaped modern technology and infrastructure.

| Fellow | Entity | Impact/Notes |
| :---- | :---- | :---- |
| [**Vitalik Buterin**](https://ca.linkedin.com/in/vitalik-buterin-267a7450) | **Ethereum** | Launched the first sale of Ether during the fellowship, credited with a massive portion of the $550B+ value creation. |
| [**Dylan Field**](https://www.linkedin.com/in/dylanfield) | **Figma** | Clear vision from day one to build tools for creation; took 12-14 years to reach IPO. |
| [**Ritesh Agarwal**](https://in.linkedin.com/in/riteshagar) | **OYO Rooms** | Initially an **Airbnb** clone for India, pivoted to build the world's second largest hotel chain. |
| [**Laura Deming**](https://www.linkedin.com/in/laura-deming-b255362a) | **Longevity Fund** | Entered at 17, shifted focus to venture capital to solve the funding bottleneck in longevity research, now working on cryopreservation. |
| [**Chris Olah**](https://www.linkedin.com/in/christopher-olah-b574414a) | **Anthropic** | Fellowship researcher in Machine Learning, moved from **Google** Brain/**OpenAI** to the founding team of **Anthropic**. |

## **Selection Methodology**

The fellowship team utilizes a distinct set of traits and metaprocesses to identify high potential individuals before they have established track records.

### **Essential Traits**

* **Hyperfluency:** The ability to be deeply passionate about a technical area and scaffold language, speaking both to high level experts and laypeople with equal clarity.  
* **Alchemy:** A team's ability to stretch resources in surprising, almost magical ways (e.g., sourcing rare materials from junkyards or finding $100,000 equipment on **eBay** for $7,000).  
* **Courage:** Prioritizing the courageous leap over raw genius, looking for those willing to sound absurd or crazy with their goals.

### **Evaluation Metrics**

* **The Ambition/Ability Quadrant:** A whiteboard system mapping applicants based on the scale of their goals (Ambition) versus their capacity to actually begin building (Ability to get started).  
* **The Energy Test:** A qualitative assessment of whether an interaction with the applicant left the team with more or less energy.  
* **The Contrarian Truth:** The famous [Peter Thiel](https://www.linkedin.com/in/peterthiel) question: “What is something you believe to be true that no one else believes?”

### **The Anti-Trait: The Cloud of Abstractions**

The team actively avoids candidates who stay in the stratosphere of high level theory. If a candidate cannot answer what they are doing on a specific Friday to move their project forward, or claims they cannot start without capital, they are viewed as lacking the necessary ability to get started.

## **Cultural and Psychological Impact**

Beyond financial outcomes, the **Thiel Fellowship** acted as a cultural movement that changed how society views non-traditional paths.

### **Normalizing the Gap Year**

Before the fellowship, the concept of a gap year or stopping out was largely absent in American culture. The program provided a talking point for young people to use with parents and institutions, effectively normalizing the idea that high achieving individuals could pause formal education to build.

### **Community and Peer Bonding**

The program emphasized the average of five people theory. Fellows often lived together in group houses (e.g., Mission Control) in San Francisco. This community was vital because early fellows faced significant media hostility. Reporters often targeted individual fellows, viewing their choice to leave school as an implicit attack on those who stayed.

### **Psychological Games**

The fellowship used social games like Mafia (Werewolf) during retreats. These games were used to observe social dynamics, deception, and metagaming behaviors, which often correlated with a fellow's ability to navigate complex real-world environments.

## **1517 Fund and the Future of Patronage**

In 2015, members of the fellowship leadership ([Danielle Strachman](https://www.linkedin.com/in/daniellestrachman) and [Michael Gibson](https://www.linkedin.com/in/michael-patrick-gibson-56b6973)) transitioned to form **1517 Fund**, a venture capital firm designed to scale the fellowship's philosophy.

* **The Investment Gap:** **1517** was founded because traditional VCs in 2010-2015 often looked for university degrees or internships rather than backing teenage founders directly.  
* **Direct Patronage:** The fund promotes a model where money is given directly to individuals rather than institutions, operating on the belief that individuals can be trusted to allocate resources more effectively than systems.  
* **Expanding the Frontier:** The focus has shifted toward Sci-Fi tech, deeptech problems like rare earth metal extraction at lower energy costs or infrastructure replacements for copper wiring.  
* **Going Younger:** Future goals include funding creative and technical individuals as young as 11, pushing the barrier of entry for "frontiers of knowledge" even lower.

## **Perspectives on Peter Thiel**

The document notes that while [Peter Thiel](https://www.linkedin.com/in/peterthiel) is a controversial figure, his influence on the educational conversation is often unacknowledged.

* **First Principles Thinking:** [Thiel](https://www.linkedin.com/in/peterthiel) is characterized as a thinker who refuses canned answers, often pausing for long periods to update his mental models in real-time.  
* **Constant Iteration:** [Thiel](https://www.linkedin.com/in/peterthiel) frequently does 180s on program directions, requiring his team to be as adaptable as he is.  
* **The Evil Label:** Public perception of [Thiel](https://www.linkedin.com/in/peterthiel) as Evil is attributed to his willingness to threaten established systems and beliefs, as well as his political affiliations, which some find inherently threatening to their own built realities.

# 2025-09-01

# **Apple’s $275 Billion Integration with China**

## **Executive Summary**

The following document synthesizes key insights regarding **Apple**’s deep industrial and financial integration with China. Driven by CEO [Tim Cook](https://en.wikipedia.org/wiki/Tim_Cook), often characterized as "Mr. Spreadsheet", **Apple** transitioned from a company on the brink of bankruptcy in the late 1990s to a global production giant by leveraging China’s abundant labor and welcoming industrial policy.

Central to this relationship is a $275 billion investment pledge made by [Cook](https://en.wikipedia.org/wiki/Tim_Cook) to the Chinese government, a figure that dwarfs major historical and contemporary state-led economic initiatives. While this strategy allowed **Apple** to redefine computer aesthetics and dominate the smartphone market, it has resulted in a state of geopolitical capture. **Apple** effectively trained its own competitors and built a sophisticated ecosystem that now encircles the company, leaving it with few viable options for relocation to the United States or India.

## **The Scale of Investment**

**Apple**’s financial commitment to China is staggering in its magnitude, often exceeding the scale of national industrial policies.

* **The $275 Billion Pledge:** In response to threats of blacklisting by Beijing hardliners in 2013, [Tim Cook](https://en.wikipedia.org/wiki/Tim_Cook) negotiated a deal to invest $275 billion over five years.  
* **Comparative Benchmarks:**  
  * **The U.S. CHIPS Act:** Provides $52 billion over four years. **Apple**’s annual investment in China is roughly equivalent to one CHIPS Act per year.  
  * **The Marshall Plan:** Historically valued at $130 billion in inflation adjusted dollars. **Apple**’s five year pledge represents approximately two Marshall Plans.  
* **Long term Cumulative Spend:** Estimates suggest that if 22% of **Apple**’s revenue has been funneled into the Chinese supply chain since the iPhone’s 2007 debut, the total investment through 2025 would exceed $800 billion, approaching $1 trillion.

## **The Tim Cook Doctrine**

The document identifies a fundamental tension in [Tim Cook](https://en.wikipedia.org/wiki/Tim_Cook)’s leadership style, which prioritizes data-driven management over unmeasurable geopolitical risks.

* **What Gets Measured Gets Managed:** [Cook](https://en.wikipedia.org/wiki/Tim_Cook) is renowned for an insatiable demand for detail, once extending a two hour data meeting to 13 hours. This focus has led to exceptional margins and supply chain mastery.  
* **The Strategic Blind Spot:** The briefing posits that while [Cook](https://en.wikipedia.org/wiki/Tim_Cook) excels at managing anything that can fit on an Excel sheet, he has a blind spot for elements that cannot be measured, such as shifting cultural tides, political volatility, and the long term risk of arming a primary geopolitical adversary.

## **Manufacturing Philosophy**

**Apple**’s move to China was not initially motivated by the country’s technical competence, but by the sheer scale of available labor and the government's ability to build factories at high speed.

### **Redefining Production Standards**

Unlike competitors like **Dell** or **HP**, who used Design for Assembly (DFA) or idiot-proof assembly (Poka-Yoke), **Apple** adopted an anti-DFA approach.

* **Complexity as a Moat:** **Apple** designed products that were intentionally difficult to assemble and copy. This required the nimbleness of hundreds of thousands of human workers rather than automated, standardized lines.  
* **Technical Training:** **Apple** did not find a skilled workforce, it created one. The company sent planeloads of engineers to Chinese factories to teach Engineering 101 and train workers to meet Apple’s exacting standards.

### **The Human Infrastructure**

The scale of **Apple**’s production relies on China’s floating population, estimated to be larger than the entire population of the United States.

* **The Hukou System:** Workers from rural areas hold a rural hukou (household registration), which prevents them from accessing public services (schools, benefits) in industrial hubs like Shenzhen or Suzhou.  
* **Seasonal Labor:** This population functions as a massive, temporary workforce that follows product cycles, such as iPhone production, working 12 hour days, six days a week.

## **Geopolitical Capture**

The briefing concludes that **Apple** is currently captured by the very ecosystem it helped create.

### **The Go Strategy**

While Western strategy often mirrors Chess (seeking a decisive checkmate move), China’s strategy is compared to the game of Go, where the objective is to gradually encircle the opponent.

* **Loss of Decisive Moves:** **Apple** is now encircled by Chinese competitors (**Huawei**, **Xiaomi**, **OPPO**, **Vivo**) that use the same suppliers **Apple** originally trained.  
* **The Death of Nokia:** Analysis suggests **Apple** did not kill **Nokia** through market share alone (**Apple**’s share has rarely exceeded 20%). Instead, **Apple** trained a supply chain that empowered Chinese competitors to take the remaining 80% of the market, effectively squeezing out legacy players like **Nokia**.

### **Manufacturing Conditions and Ethical Tensions**

The document notes that while **Apple**’s presence spurred Chinese industrialization, the conditions remain grueling:

* **Task Intensity:** Workers often have only 9 to 11 seconds to perform a specific task.  
* **Management Practices:** Historically, workers have been subjected to no talking and no smiling rules. The 2010 suicide crisis at **Foxconn** resulted in the installation of suicide nets and mandatory pledges from workers, responses characterized as awful.

## **OpenAI and the Hardware Conundrum**

The potential for new hardware entrants (such as the rumored [Sam Altman](https://en.wikipedia.org/wiki/Sam_Altman) and [Jony Ive](https://en.wikipedia.org/wiki/Jony_Ive) collaboration) faces the same China trap that **Apple** created.

| Challenge | Detail |
| :---- | :---- |
| **Manufacturing Disadvantage** | Attempting to build outside China (e.g., in the U.S. or India) puts a company at a disadvantage against **Apple**'s entrenched Chinese ecosystem. |
| **The App Gravitation** | Given the difficulty of scaling hardware to millions of units, many AI hardware innovations may eventually be forced to exist merely as apps on the 1.5 billion existing iPhones. |
| **Intellectual Property Risk** | The source suggests that manufacturing in China carries an inherent risk of design patterns and blueprints being shared across factory lines, a phenomenon **Apple** has dealt with throughout its tenure. |

# 2025-09-04

# **Hello Patient and the Evolution of Healthcare AI**

## **Executive Summary**

This document provides a comprehensive overview of the founding, funding, and strategic direction of **Hello Patient**, a healthcare focused conversational AI company. Led by CEO and Meme Lord [Alex Cohen](https://www.linkedin.com/in/alexander-cohen), the company recently secured a $22.5 million Series A funding round. **Hello Patient** distinguishes itself by focusing strictly on the administrative and patient-facing communication layers of healthcare, such as scheduling and triaging, rather than clinical diagnosis. The company leverages a unique marketing strategy rooted in viral shitposting and high production parody videos to drive inbound leads and network access. Key technical insights suggest that while the industry is shifting toward AI comfort, true Artificial General Intelligence (AGI) remains five to seven years away due to the current lack of context aware autonomous reasoning in agents.

## **Corporate Profile and Founding Story**

[Alex Cohen](https://www.linkedin.com/in/alexander-cohen) founded **Hello Patient** after a tenure at **Carbon Health**, where he led patient engagement and call center operations. The company's origin and brand are inextricably linked to [Cohen](https://www.linkedin.com/in/alexander-cohen)’s public persona as a satirical commentator on Silicon Valley culture.

### **The Fired CEO Persona**

[Cohen](https://www.linkedin.com/in/alexander-cohen) has cultivated a viral reputation for being fired from numerous high profile companies, a narrative largely driven by satirical social media posts. The transcript identifies a list of entities from which he has jokingly or semi-seriously claimed to be terminated:

* **Technology/Social Media:** **Twitter** (the original viral thread regarding [Elon Musk](https://en.wikipedia.org/wiki/Elon_Musk)), **Meta**, **Google** (Gemini algorithm), and **Astronomer**.  
* **Public/Political Sector:** The **IRS** (DEI Coordinator), the [Harris](https://en.wikipedia.org/wiki/Kamala_Harris) Campaign, and the **CrowdStrike** server room (joking about the global internet outage).  
* **Corporate/Retail:** **BMW** (heated seat subscriptions) and **Wendy**'s (surge pricing innovation).

### **Marketing and Viral Strategy**

**Hello Patient** utilizes high production parody videos to coincide with funding rounds:

* **Seed Round:** A parody of the **Humane** AI Pin launch video.  
* **Series A Round:** A parody of the [Sam Altman](https://en.wikipedia.org/wiki/Sam_Altman) and [Jony Ive](https://en.wikipedia.org/wiki/Jony_Ive) **OpenAI** hardware announcement video, featuring specific wardrobe choices like [Sam Altman](https://en.wikipedia.org/wiki/Sam_Altman)’s **LEGO** shoes and a [Jony Ive](https://en.wikipedia.org/wiki/Jony_Ive)\-style Safari jacket.  
* **Impact:** [Cohen](https://www.linkedin.com/in/alexander-cohen)’s **Twitter** presence (approx. 230,000 followers) serves as a competitive advantage, providing direct DM access to billionaires and driving the majority of the company’s inbound website traffic.

## **Product Architecture and Market Focus**

**Hello Patient** provides an omnichannel conversational AI suite designed specifically for healthcare practices.

### **Core Capabilities**

The platform handles patient-facing communications through three primary channels:

1. **Voice:** Answering inbound calls and making outbound calls.  
2. **Texting:** Automated SMS outreach and follow-ups.  
3. **Web Chat:** Conversational AI agents embedded on practice websites.

### **Functional Scope: Administrative vs. Clinical**

The company intentionally avoids the Doctor GPT model, focusing exclusively on administrative functions to mitigate liability and regulatory risks.

* **Inbound Workflows:** Handling appointment bookings, insurance verification, and basic triaging (e.g., determining if a sinus infection requires an urgent or routine visit).  
* **Outbound Workflows:** Running campaigns for missed appointments, such as allergy shots or routine cleanings.  
* **Exclusions:** The AI does not perform clinical diagnoses or handle complex provider to payer communications like prior authorizations or denial appeals.

### **Target Verticals**

**Hello Patient** prioritizes specialties with high patient choice and competitive marketing funnels:

* **Current Primary Verticals:** Urgent Care, Primary Care, ENT (Ear, Nose, and Throat), Allergy, Mental/Behavioral Health, and Med Spas.  
* **Emerging Verticals:** Vision Care (Optometry) and Dental.

## **Financials and Growth Metrics**

The company has transitioned from a small R\&D focused team to a scaling enterprise backed by major venture capital firms.

### **Funding History**

| Round | Amount | Lead Investor | Key Participants |
| :---- | :---- | :---- | :---- |
| **Seed / Extension** | \~$3.8M+ | **8VC** | **Bling Capital**, **Max Ventures** |
| **Series A** | $22.5M | **Scale Venture Partners** | **8VC**, **Alumni Ventures**, **Remis Capital**, Lord [David Prior](https://en.wikipedia.org/wiki/David_Prior,_Baron_Prior_of_Brampton) (UK) |

### **Operational Scale**

* **Current Volume:** Tens of thousands of conversations per day.  
* **12-Month Goal:** Scale to millions of conversations per day and thousands of live clinics.  
* **Headcount:** 15-16 people, including Agent Architects who specialize in a mix of prompt engineering, Data Science, and NLP.

## **Technical Infrastructure and AI Outlook**

The technology stack is a hybrid of best-in-class third-party models and custom orchestration.

### **The Tech Stack**

* **Language Models:** Primarily **OpenAI**. [Cohen](https://www.linkedin.com/in/alexander-cohen) notes that Gemini and Claude are currently too slow for real-time phone latency, and Llama has struggled with following complex instructions.  
* **Voice/Audio:** **Cartesia** and **ElevenLabs** for text-to-speech, **Deepgram** for transcription.  
* **Custom Layer:** The internal orchestration layer handles EHR (Electronic Health Record) integrations and ensures the AI follows the specific workflow of a medical practice.

### **AGI and the Future of AI**

[Cohen](https://www.linkedin.com/in/alexander-cohen) posits that AGI is 5 to 7 years away. He defines the threshold for AGI as the ability to give an agent raw information and system access and have it figure out a job autonomously. Currently, agents are deemed dumb without highly specific, deterministic context provided by human architects.

## **Industry Challenges and Regulatory Landscape**

Operating in healthcare requires navigating high stakes technical and legal barriers.

* **Staffing Crisis:** The primary driver for adoption is not cost saving but a fundamental staffing shortage. Clinics report an inability to hire enough qualified front desk and call center staff.  
* **Data Integrity:** **Hello Patient** maintains HIPAA compliance and signs Business Associate Agreements (BAAs). A core strategy is to minimize the amount of patient data stored in their own databases to reduce risk.  
* **Legacy Competition:** Established EHRs (**Epic**, **Athena**, **ModMed**) are viewed as billing-first rather than patient-first. [Cohen](https://www.linkedin.com/in/alexander-cohen) argues that these incumbents are two to three years behind in developing bidirectional, conversational engagement tools.

## **Personal Optimization and Biohacking**

Reflecting the Austin/Silicon Valley culture, [Cohen](https://www.linkedin.com/in/alexander-cohen) discussed extensive personal health optimization as a means to maintain performance.

### **Peptide and Hormone Therapy**

[Cohen](https://www.linkedin.com/in/alexander-cohen) utilizes a longevity doctor and a regimen of peptides for recovery and growth:

* **TRT (Testosterone Replacement Therapy):** Described as life-changing for muscle growth and mental clarity, though [Cohen](https://www.linkedin.com/in/alexander-cohen) noted it requires cycling for fertility reasons.  
* **Recovery Peptides:** BPC-157 (used for back injury recovery) and CJC-1295 (growth hormone signaling).  
* **Metabolic Health:** Microdosing Tirzepatide (a GLP-1) to manage food noise and mitigate the effects of the processed American food system.  
* **Sleep:** Use of DSIP (Deep Sleep Inducing Peptide) and tracking via **Oura Ring** and **Eight Sleep**.

### **Philosophical View on Health**

[Cohen](https://www.linkedin.com/in/alexander-cohen) argues that the American food system is fundamentally broken due to food lobbies and processed ingredients, leading to hormonal imbalances. He views peptides and GLP-1 as necessary supplements (comparable to creatine) to offset environmental and systemic health challenges.

# 2026-09-07

# **Innovations in American Air and Sea Travel**

## **Executive Summary**

The American transportation sector is undergoing a generational shift driven by electrification, autonomous systems, and advanced manufacturing. This document synthesizes insights from the leadership of three pioneering companies, **Archer**, **Regent**, and **Ark**, representing the next frontier in air and sea travel.

**Key takeaways include:**

* **A New Era of Aviation:** **Archer** is commercializing the first new FAA aircraft category in 60 years, targeting the massive air taxi market and defense applications with its Midnight eVTOL aircraft.  
* **Maritime Speed Revolution:** **Regent** is filling the regional transport gap with seagliders, hybrid boat-planes that operate eight times faster than traditional vessels while utilizing maritime (Coast Guard) rather than aviation (FAA) certification pathways.  
* **Software-Defined Boating:** **Ark** is modernizing the recreational and commercial boating industries through vertical integration and high capacity battery packs, transitioning boats from leaf blower levels of inefficiency to high performance, software integrated platforms.  
* **Strategic Reindustrialization:** All three companies emphasize US based manufacturing (Georgia, Rhode Island, and California) as a core strategy for safety, cost control, and national security.  
* **Defense Integration:** There is a significant convergence between civil and defense applications, specifically in contested logistics for the Indo-Pacific theater and autonomous attritable aircraft.

## **Archer: The eVTOL and Air Taxi Market**

**Archer Aviation** is focused on vertical lift aircraft designed to solve the cost, safety, and noise limitations of traditional helicopters.

### **Product and Performance**

* **Midnight Aircraft:** A piloted, four passenger vehicle designed for city environments (e.g., Manhattan to JFK).  
* **Capabilities:** Range of up to 100 miles with speeds of 150 mph.  
* **Safety Redundancy:** The aircraft features 12 sets of independent engines and propellers powered by six battery packs. This configuration eliminates single points of failure; the aircraft can lose a battery pack or an engine and still maintain balanced flight.

### **Market Opportunity and Scale**

* **TAM Projection:** CEO [Adam Goldstein](https://www.linkedin.com/in/adam-goldstein-7b662121) estimates that placing just 20 aircraft in the top 1,000 global cities represents a 100 billion market (5 million per aircraft) before even factoring in the dedicated air taxi or defense sectors.  
* **Demand Drivers:** Unlimited consumer demand driven by the desire to bypass ground traffic (turning a 90 minute car ride into a 5 minute flight).

### **Strategic Milestones**

| Milestone | Details |
| :---- | :---- |
| **FAA Classification** | First new aircraft category created in 60 years. |
| **Manufacturing** | High volume factory on 100 acres in Covington, Georgia, designed for thousands of units per year. |
| **LA 2028 Olympics** | Partnered for Innovate 28, intended to be the first large scale global demonstration of eVTOL fleets. |
| **Global Expansion** | Significant investment and partnership with **Mubadala** (UAE) and **United Airlines**. |

## **Regent: Seagliders and Regional Mobility**

**Regent** is pioneering seagliders, a hybrid between a boat and a plane that utilizes the wing-in-ground effect to fly within a wingspan’s height of the water’s surface.

### **Performance Differentiation**

* **Speed:** Seagliders travel at 160 knots (approx. 180 mph), roughly eight times faster than traditional surface vessels (20 knots).  
* **Range:** Currently 180 miles on battery technology alone.  
* **Versatility:** Unlike seaplanes, seagliders use hydrofoils to take off and land in high sea states (up to 5 foot waves), retracting the foils once in flight to reduce drag.

### **Regulatory Advantage**

A key strategic insight for **Regent** is the classification of seagliders as vessels under maritime jurisdiction (U.S. Coast Guard) rather than aircraft (FAA). This avoids the lengthy certification delays currently hampering electric aviation.

### **Defense Applications (Regent Defense)**

* **Contested Logistics:** Addressing the resupply problem in the Indo-Pacific. A trip from Guam to the first island chain takes 4-5 days by boat but only 10 hours via seaglider.  
* **Low Signature:** Electric propulsion and low altitude flight make seagliders difficult to detect via sonar or long range radar.

## **Ark: The Modernization of Maritime Powertrains**

**Ark** is focused on rebuilding the maritime industry by replacing loud and noxious internal combustion engines with fully electric and hybrid-electric powertrains.

### **Vertical Integration and Engineering**

* **In-house Battery Production:** **Ark** builds its own 226 kWh battery packs (roughly the size of multiple electric sedans) to ensure the vessel structure is optimized for weight and power.  
* **Rapid Development:** The company moved from zero to first boat on water in three months and to customer delivery within 24 months.

### **Software as a Competitive Moat**

**Ark** leverages software engineers (a rarity in traditional boat building) to provide features previously unavailable in the industry:

* **Steering in Reverse:** Using software to coordinate thrusters and propulsion.  
* **Station Keeping:** Automatically holding the boat in a fixed GPS position.  
* **Safety Features:** Skier-down detection via onboard cameras and automated recording for social sharing.

## **Cross-Sector Strategic Themes**

### **Reindustrialization and Labor**

The three CEOs highlight a shift back to US manufacturing to reclaim technical superiority:

* **Archer:** Utilizing Georgia for high volume aviation manufacturing.  
* **Regent:** Based in Rhode Island, leveraging the state’s legacy of high-end carbon fiber engineering from the sailing industry (America's Cup).  
* **Ark:** Manufacturing in Torrance, California, attracting talent from **SpaceX**, **Tesla**, and **Rivian**.

### **The Role of Artificial Intelligence**

AI is viewed not as a replacement for physics based engineering but as an optimizer:

* **Air Traffic Control (ATC):** **Archer** views AI as essential to revolutionizing the manual, human-centric ATC systems to support thousands of urban flights.  
* **Manufacturing Efficiency:** **Ark** uses AI for anomaly detection in boat data and to automate the generation of complex manufacturing work instructions.  
* **Deterministic vs. Stochastic:** **Regent** emphasizes that for safety critical flight, deterministic math and physics based algorithms remain the underpin, with AI utilized for higher-level autonomy (e.g., pathfinding).

### **Defense and National Security**

A peace through strength philosophy permeates the sector. The United States is increasingly looking toward these commercial startups to provide autonomous, attritable (low cost, replaceable) aircraft and high speed maritime logistics to deter global conflicts, particularly in the Taiwan Strait.

"A surface vessel today is going to go 20 knots... a seaglider can fly at 160 knots... we're eight times faster. In the Pacific, that's the difference between a five day sail and a 10 hour flight",  [Billy Thalheimer](https://www.linkedin.com/in/williamthalheimer)

# 2026-09-08

# **2026-09-08 High-Stakes Innovation and Technology Journalism**

## **Executive Summary**

This document synthesizes key themes from an analysis of contemporary technological figures and the realities of reporting on the frontier of science and industry. The discourse centers on the psychological profiles of ultra successful innovators, specifically [Elon Musk](https://en.wikipedia.org/wiki/Elon_Musk) and [Bryan Johnson](https://www.linkedin.com/in/bryanrjohnson/), and the radical persistence required to disrupt established industries.

Critical takeaways include:

* **The Persistence Paradox:** Success in deep tech (**SpaceX**, **Neuralink**) is often driven by an almost pathological level of focus and a willingness to operate outside standard human limits (e.g., 4:00 AM meetings and sleeping at production sites).  
* **The Evolution of the Polarizing Figure:** Public perception of figures like [Musk](https://en.wikipedia.org/wiki/Elon_Musk) and [Johnson](https://www.linkedin.com/in/bryanrjohnson/) often shifts from idolization to vilification, influenced by political engagement and unfiltered communication styles on social media.  
* **Frontier Science Challenges:** Emerging fields such as quantum computing and fusion remain difficult to vet, oscillating between legitimate breakthroughs and science projects that have yet to achieve commercial inflection points.  
* **The Ethics of Radical Innovation:** From DIY self-driving cars to suburban Russian cryonics labs, the nerd archetype often operates in a legal and safety vacuum to push boundaries.

## **The Profiles of Disruptive Innovators**

The source context provides an incisive look into the habits and philosophies of two of the most polarizing figures in modern technology.

### **Elon Musk: Radical Focus and Work Ethic**

The analysis identifies persistence and focus as the primary drivers behind [Musk](https://en.wikipedia.org/wiki/Elon_Musk)’s success, particularly in contrast to competitors.

* **Operational Tempo:** [Musk](https://en.wikipedia.org/wiki/Elon_Musk) maintains a near constant operational state, involving international travel and back-to-back meetings at companies like **Neuralink** and **xAI**, sometimes as late as 1:00 AM or as early as 4:00 AM.  
* **Prioritization:** A core lesson derived from [Musk](https://en.wikipedia.org/wiki/Elon_Musk) is the ability to ignore peripheral noise and concentrate exclusively on variables that determine long term impact.  
* **The Bad Elon Transition:** The shift in [Musk](https://en.wikipedia.org/wiki/Elon_Musk)’s public persona is traced back to the Model 3 production disaster, where the stress of the project coincided with a more aggressive and polarizing presence on social media.  
* **SpaceX vs. Blue Origin:** The source suggests that **SpaceX** has lapped competitors like **Blue Origin** because of an organizational culture that oozes from [Musk](https://en.wikipedia.org/wiki/Elon_Musk)’s own willingness to live at his factories, even while being the world’s wealthiest individual.

### **Bryan Johnson: Transformation and Influence**

[Bryan Johnson](https://www.linkedin.com/in/bryanrjohnson/) is characterized by a wholesale change in personality and objective around the age of 35\.

* **Resilience to Criticism:** Formerly thin-skinned and sensitive, [Johnson](https://www.linkedin.com/in/bryanrjohnson/) has transitioned to a figure who revels in public skepticism regarding his **Blueprint** and Don't Die movements.  
* **The Rub-Off Effect:** [Johnson](https://www.linkedin.com/in/bryanrjohnson/)’s lifestyle, centered on extreme longevity and health, exerts a significant psychological influence on those around him, often leading collaborators to adopt rigorous sleep and dietary habits.  
* **From CPG to Frontier Science:** While [Johnson](https://www.linkedin.com/in/bryanrjohnson/) achieved commercial success in Consumer Packaged Goods (CPG) through storytelling and branding, his true interest lies in the frontier science of body-health optimization.

## **Notable Figures in the Nerd Pantheon**

The document outlines several individuals who represent different eras and styles of technical brilliance.

| Individual | Contribution/Context | Key Detail |
| :---- | :---- | :---- |
| [**Carver Mead**](https://en.wikipedia.org/wiki/Carver_Mead) | Semiconductor Pioneer | Coined the phrase "Moore's Law", described as having ideas as big as [Einstein](https://en.wikipedia.org/wiki/Albert_Einstein). |
| [**Daniil Medvedev**](https://en.wikipedia.org/wiki/Daniil_Medvedev) | Russian Cryonics Leader | Operated a suburban Moscow lab with human heads stored in **Home Depot** style freezers. |
| [**George Hotz**](https://www.linkedin.com/in/george-hotz-b3866476/) | DIY Innovator | Built a functional self-driving car in his garage in one month using a video game joystick. |
| [**Palmer Luckey**](https://www.linkedin.com/in/palmer-luckey-21a16959) | Tech Entrepreneur | Cited as a high energy guest who helped rev up the Core Memory series. |
| [**Priscilla Chan**](https://www.linkedin.com/in/priscilla-chan-907181a3/) | Philanthropist/Scientist | Noted for her focus on science and her selective approach to public interviews. |

## **The Realities of Frontier Technology Journalism**

Reporting on advanced technology involves navigating high risk environments and complex financial structures.

### **The Cost of Deep Reporting**

* **Institutional Support:** Entities like **Bloomberg** have historically supported deep journalism through generous expense policies, including business class travel for reporters to reach remote locations like Shenzhen or Ukraine.  
* **Logistical Failures:** Journalists often find themselves in limbo when dealing with state-run infrastructure (e.g., **China Air**), requiring immediate, high cost pivots to maintain reporting schedules.

### **The Difficulty of Vetting Moonshots**

The source identifies Quantum Computing and Fusion as the most challenging areas to report on accurately.

* **The Credibility Gap:** Experts in these fields are often highly convincing, making it difficult for observers to distinguish between shady actors and super smart people who have simply convinced themselves of their own hype.  
* **The Science Project Phase:** Despite significant capital raises since at least 2012 (e.g., **D-Wave**), these technologies have not yet reached a definitive solved or commercial inflection point.

## **Physical Risk and Safety in Innovation**

The pursuit of core memories in technology often leads to significant physical risks.

* **Environmental Hazards:** Reporting on Soviet-era tech programs has led to exposure to uranium processing facilities and ICBM manufacturing plants in Siberia and Ukraine.  
* **Experimental Vehicles:** The source suggests that being a passenger in first-time experimental flights or DIY self-driving cars is often more dangerous than radiation.  
* **The 12 G Scenario:** In the context of space tourism (e.g., **Blue Origin**), emergency procedures such as hatch ejection could subject the human body to 12 Gs, which is described as physically catastrophic (your brain flattens).

## **Professional Infrastructure and Tools**

The document highlights specific platforms that support the modern entrepreneurial and AI landscape.

* **Financial Management:** **Brex** is identified as a critical financial stack for venture backed startups, providing treasury services and high yield accounts to help founders avoid cash flow failures.  
* **Artificial Intelligence:** **Turing Intelligence** is noted for building customizable AI systems designed to solve mission critical challenges and accelerate business growth for top-tier companies.

# 2025-09-10

# **PsiQuantum and the Path to Large Scale Quantum Computing**

## **Executive Summary**

**PsiQuantum** is positioning itself as a Frontier technology company, analogous to **SpaceX**, **Nvidia**, and **ASML**, with the goal of building the world’s first commercially useful quantum computer. Having raised nearly $2 billion in private capital, the company has explicitly rejected the industry standard incrementalism, building small, NISQ era systems, in favor of a direct path to a million qubit machine.

The company's strategy hinges on three pillars: leveraging the existing tier-one semiconductor supply chain (specifically **GlobalFoundries**), securing massive infrastructure for cooling and power in Australia and Chicago, and focusing on applications in chemistry and materials science that are unsolvable by conventional supercomputers. **PsiQuantum** aims to have its first large scale site in Australia enabled by the end of 2027, viewing the technology as a bridge to the future, as conventional Moore's Law scaling reaches its physical limits.

## **Core Strategic Philosophy: The Million Qubit Mandate**

**PsiQuantum**’s foundational thesis is that quantum computing is a zero to one technology. Unlike software as a service (SaaS) or incremental hardware, a quantum computer has no commercial utility until it reaches a massive scale capable of error correction.

* **The Scale Threshold:** While competitors like **Google** have demonstrated \~100 qubit systems, the general consensus is that a million qubits are required for commercially impactful work.  
* **The Rocket Engine Analogy:** The company compares building small systems to building 10 foot ladders to reach the moon. **PsiQuantum** instead invests in rocket engine technology, semiconductor manufacturing, networking, and cooling that may not fly immediately but is necessary for the final destination.  
* **Rejection of Intermediate Revenue:** **PsiQuantum** avoids twisting itself into knots to produce revenue from small, useless machines. The company views these as pedagogical tools rather than commercial products.

## **Manufacturing and Infrastructure Strategy**

A critical differentiator for **PsiQuantum** is its integration with the established semiconductor industry. The company operates more like a 1980s style Silicon Valley chip company than a modern software startup.

### **Tier-One Foundry Integration**

**PsiQuantum** has spent over $100 million over eight years to establish its manufacturing process at **GlobalFoundries** (GF) in upstate New York.

* **Scale and Precision:** By using a tier-one 300mm foundry, the company gains the uniformity and high device performance necessary to produce thousands of identical chips.  
* **Sovereign Manufacturing:** 80% of **PsiQuantum**'s supply chain is in the United States, utilizing sovereign semiconductor manufacturing capabilities.

### **Key Operational Sites**

| Site Location | Primary Function | Significance |
| :---- | :---- | :---- |
| **Brisbane, Australia** | First Large Scale System | A \~$1B AUD deal to build a massive system near the airport by 2027\. |
| **Chicago, Illinois** | Quantum Computing Campus | Anchor tenant of a $500M campus on a former US Steel site, 100MW capacity. |
| **South Bay (Milpitas)** | The **Foxconn** of Quantum | 140,000 sq. ft. facility for material production and assembly. |
| **SLAC (Stanford)** | Cryogenic Testing | Partnership with the **Department of Energy** to use a 36,000 watt liquid helium cryoplant. |
| **UK (Bristol/London)** | R\&D and Testing | Uses a decommissioned synchrotron accelerator for R\&D. |

## **Technical Innovation: Beyond the Chandelier**

**PsiQuantum** has abandoned the traditional golden chandelier dilution refrigerator in favor of cabinet style, high power cryostats that resemble conventional supercomputer racks.

* **Silicon Photonics:** The technology uses light (photons) to carry information. This necessitates the development of advanced optical switches.  
* **BTO Material Science:** The company developed Barium Titanate (BTO), which it claims is the strongest electro-optic material known to science. They are the only entity capable of producing this material on 300mm wafers.  
* **Cryogenic Scale:** The systems require industrial scale helium liquifiers. The planned sites are roughly 100MW, 100,000 square foot facilities requiring hundreds of tons of hardware to maintain temperatures of \-270°C.

## **External Validation and Red Teaming**

Given the high capital requirements and lack of a current market product, **PsiQuantum** has undergone rigorous third-party scrutiny.

* **DARPA Validation:** **DARPA** conducted a red team assessment with 50 scientists and engineers explicitly tasked with finding flaws in the approach. **PsiQuantum** is one of only two companies to graduate to the final phase of this program.  
* **Australian Government Diligence:** An 18 month process involved physical lab inspections and data reproduction. While the Chief Scientist was initially skeptical, the process concluded that **PsiQuantum** was a country mile ahead of competitors.  
* **Strategic Investors:** The cap table includes **BlackRock**, **Baillie Gifford**, **Temasek**, and **Nvidia**. These investors treat the company as a Frontier infrastructure play similar to their early investments in **SpaceX**.

## **Commercial Applications and Value Drivers**

**PsiQuantum** targets the microscopic foundations of the global economy, problems in chemistry, physics, and math that underpin trillion dollar industries.

1. **Materials and Chemistry:** Innovations in drug discovery (small molecules), battery electrolytes, catalysts for fertilizers, and new fuels.  
2. **Simulation vs. Learning:** While AI learns from existing data (approximations), quantum computers calculate from first principles (exact results). **PsiQuantum** plans to use quantum computers to generate precise data to train conventional AI models.  
3. **Partial Differential Equations (PDEs):** Applications in fluid dynamics, aerospace, and financial modeling.  
4. **The Oracle Business Model:** The company does not intend to sell the machines. Instead, it will sell time or knowledge via a cloud-based model, potentially vertically integrating into drug or material discovery.

## **Quantum Computing and the AI Landscape**

The relationship between quantum computing and AI is complementary rather than competitive.

* **AI for Quantum:** Neural decoders are being used to run the quantum error correcting codes, significantly reducing the conventional computing power needed to manage the machine.  
* **Quantum for AI:** As conventional supercomputers face a cliff, regarding power, space, and data availability, quantum computers offer a way to continue the trajectory of technological progress.  
* **Skepticism of AI in Design:** **PsiQuantum** remains contrarian regarding AI’s role in its own development, noting that semiconductor chip design remains an old school practice where AI usage is minimal to avoid tape out errors.

## **Critical Quotes on the Future**

"Power is captured on the Frontier... Those companies are valuable almost by definition... because they're doing something so technically difficult that nobody else can do it."

"A single million qubit quantum computer would outperform the net total of conventional computing on the entire planet... we trash that capability for that specific set of problems in chemistry and material science."

"I really worry that leadership at **Google** or **Nvidia** or whatever is completely misled about the impact of the technology and when it's going to come... they know you need about a million qubits. They know you need error correction."

"We're going to get rich before we get dangerous... you should get an economic early warning sign where you see quantum computing companies doing commercially impactful things, before they scale toward systems big enough to be cryptographically relevant."

## **Timeline and Outlook**

* **2027 Milestone:** Target for enabling the first large scale site in Brisbane, Australia.  
* **Infrastructure Groundbreaking:** Groundbreaking for the Chicago and Australia sites is scheduled for the current year.  
* **Economic Impact:** Beyond direct job creation (estimated at thousands in the supply chain and site operations), the company views quantum as essential for national competitiveness and the continued growth of the global economy, as Moore's Law ends.

# 2025-09-11

# **PsiQuantum and the Evolution of Quantum Computing**

## **Executive Summary**

The quantum computing industry is transitioning from a period of academic experimentation into a phase of industrialization and product development. This **SpaceX** moment is characterized by a shift from the mere achievement of creating qubits to the massive engineering challenge of scaling them for utility.

**PsiQuantum** distinguishes itself through a pigheaded focus on building a million qubit, fault-tolerant machine, a scale deemed necessary by the company to overcome error correction requirements and perform useful work. While the field is currently defined by competing technical methodologies and significant skepticism, the prevailing sentiment among experts is that successful hardware moonshots require a 10 to 12 year trajectory, intense mission alignment, and a move away from purely academic mindsets toward Silicon Valley style semiconductor manufacturing.

## **The Current Landscape of Quantum Computing**

The field has moved past the initial science experiment phase where creating a handful of qubits was considered a rare achievement.

* **From Lab to Startup:** Quantum computing has transitioned from university labs into the venture backed startup ecosystem.  
* **Qubit Proliferation:** Basic building blocks are now more accessible. While creating two or four qubits was once the gold standard, many entities can now produce them in larger quantities.  
* **Technical Fragmentation:** The industry is currently split between various methods (e.g., photonics, ion traps). Experts note a mudslinging environment where each faction claims their specific approach is the only viable path while others are fundamentally flawed.  
* **The Science vs. Product Gap:** A major hurdle for many startups is moving beyond forever engineering to create a vaguely feasible object that can progress toward a final product.

## **PsiQuantum’s Strategic Differentiation**

**PsiQuantum**’s approach is defined by its focus on scale and its rejection of half measures.

### **The Million Qubit Goal**

While competitors may focus on reaching 64 or 128 qubits, **PsiQuantum** has maintained a consistent goal of building a machine with one million qubits. This target is driven by the requirements of error correction:

* **Error Correction Logic:** Due to the funky software techniques required for error correction, a million physical qubits are necessary to yield approximately 1,000 truly useful functional qubits.  
* **Industrial Scale:** Reaching this scale requires inventing new fields of computing and networking, moving away from exotic lab setups toward standardized manufacturing.

### **Semiconductor-Based Approach**

**PsiQuantum** is anti-chandelier (referring to the traditional aesthetic of quantum computers). Instead, they are leveraging Silicon Valley’s semiconductor roots:

* **Manufacturing:** The company produces semiconductors and wafers in Silicon Valley, utilizing high-end, government lab grade machinery to build specific components.  
* **Proof of Concept:** Over the last five years, the company has moved from theoretical ideas to prototypes and proof of concept individual components that now must be integrated.

## **The Hardware Journey and Comparisons to SpaceX**

Expert analysis suggests that hardware moonshots follow a predictable, albeit difficult, 10 to 12 year cycle.

| Stage | Timeline (Approx.) | Characteristics |
| :---- | :---- | :---- |
| **Early Phase** | Years 1-5 | Theoretical ideas, academic roots, initial prototypes. |
| **The Valley of Death** | Years 5-10 | Massive capital requirements, constant risk of bankruptcy, high skepticism from observers. |
| **The Flip** | Years 10-12+ | The technology matures, the first vaguely feasible object becomes a product, and the company begins to dominate its field. |

**SpaceX Analogy:** From 2003 to 2012, **SpaceX** appeared to be on the brink of failure. By 2018, they were flying more rockets than all competitors combined. Quantum computing is currently viewed through this lens of Hard Tech that requires a long term commitment before it flips the world.

## **Leadership and Team Management**

Managing a Deep Tech company for over a decade requires a specific cultural and psychological approach.

* **The Mission as Rocket Fuel:** A singular, unambiguously hard goal, building a fault-tolerant quantum computer, acts as a filter to attract the best talent and investors while weeding out those seeking easier outcomes.  
* **The Apollo 11 Mindset:** Leadership uses the analogy of the Apollo program to maintain alignment. When internal conflicts arise, the team is reminded of the singular moon they are aiming for to resolve misalignments.  
* **Management Philosophy:**  
  * **Always Be Impressive:** Rather than relying on polished PowerPoint slides or sales pitches, the goal is for the team to be sincere and demonstrate that they have executed what they said they would do.  
  * **Avoiding Academic Traps:** There is a recognized danger in academic cultures where the pursuit of perfection prevents the transition to a business minded startup.

## **Critical Perspectives and Skepticism**

Despite the progress, the industry remains shrouded in endless confusion and competitive jostling.

* **The Pain in the Ass Factor:** Observers note that quantum computing has a history of failed promises and remains a frustrating field to document and explain.  
* **Inner Turmoil:** The complexity of the field is so high that even experts describe a sense of inner turmoil when trying to synthesize the various claims and technologies.  
* **Historical Context:** The current chaos in quantum computing is compared to the early days of memory technology or transistor designs, many efforts will disappear, but the successful ones will form the foundation of a new industry.

"I feel confident that we'll get a footnote, at least somewhere in a history book one day... we're making mind boggling weird crazy frightening loud stuff that is thrilling to go and look at"

# 2025-09-12

# **Klarna’s Strategic Evolution and IPO Readiness**

## **Executive Summary**

This document analyzes the strategic trajectory of **Klarna**, as articulated by CEO [Sebastian Siemiatkowski](https://www.linkedin.com/in/sebastian-siemiatkowski-768977/). Following a period of significant volatility, characterized by high venture capital valuations followed by substantial losses, **Klarna** has executed a rapid redemption story, achieving profitability in less than three years.

The company’s current strategy is centered on three pillars:

1. **AI-Driven Operational Efficiency:** **Klarna** has leveraged Artificial Intelligence to reduce its workforce from 7,400 to 3,000 through attrition, while simultaneously doubling revenue and increasing revenue per employee to over $1 million.  
2. **Disruption of Retail Banking:** **Klarna** aims to evolve from a "Buy Now, Pay Later" (BNPL) provider into a global digital financial assistant, targeting the $1.2 trillion U.S. credit card market and challenging incumbents like **JPMorgan Chase**.  
3. **Brand Differentiation:** By maintaining a distinctive, edgy aesthetic and emotional connection with consumers, originally established through the Smooth campaign, **Klarna** seeks to distinguish itself from traditional, boring banking institutions.

## **The Path to a Trillion-Dollar Valuation**

**Klarna** identifies the retail banking and credit card industry as a market ripe for massive disruption. [Siemiatkowski](https://www.linkedin.com/in/sebastian-siemiatkowski-768977/) views the current $1.2 trillion U.S. credit card market as characterized by excess profit and low customer mobility.

### **Strategy for Market Disruption**

* **The Digital Financial Assistant:** The goal is to move beyond transaction based lending to a comprehensive digital assistant that proactively manages a user's finances (e.g., switching mortgages or electricity providers to save money).  
* **Customer-Centricity:** The company positions itself as a friendlier alternative to traditional banks, which [Siemiatkowski](https://www.linkedin.com/in/sebastian-siemiatkowski-768977/) argues have historically relied on customer inertia and confusing products (like revolving debt) to maximize profits.  
* **Scale and Global Presence:** Achieving a trillion dollar valuation requires a dominant presence in both the U.S. and Europe, focusing on massive user scale to drive the financial assistant model.

## **Operational Transformation Through AI**

**Klarna**’s integration of AI is not merely an incremental improvement but a fundamental restructuring of the business model.

### **The OpenAI Partnership**

[Siemiatkowski](https://www.linkedin.com/in/sebastian-siemiatkowski-768977/) aggressively sought an early partnership with **OpenAI**, positioning **Klarna** as a guinea pig for new technologies. This led to:

* **Internal Innovation:** Employees were encouraged to experiment with AI, leading to novel internal tools, such as an AI system that conducts 30 minute in-depth interviews with employees to gauge engagement more effectively than traditional surveys.  
* **Software Consolidation:** **Klarna** is actively removing non-cooperative SaaS vendors that do not offer public APIs or support AI integration. The company favors standardization and harmonization of data to ensure AI agents have full context.

### **Efficiency and Headcount Metrics**

The document highlights a dramatic shift in operational efficiency:

| Metric | Previous State | Current State |
| :---- | :---- | :---- |
| **Total Employees** | 7,400 | 3,000 |
| **Revenue per Employee** | \~$450,000 | \>$1,000,000 |
| **Profitability** | \-$100M loss/month | \+$1M to $2M profit/month |

* **Attrition over Layoffs:** Since stopping recruitment two years ago, **Klarna** has shrunk its workforce through natural attrition (roughly 20% annually).  
* **Economic Incentives:** A portion of the savings from reduced payroll has been redirected to increase compensation for the remaining employees, incentivizing them to participate in the efficiency drive.

### **Vibe Coding**

[Siemiatkowski](https://www.linkedin.com/in/sebastian-siemiatkowski-768977/) describes a shift in product development where non-engineers (including himself) use AI tools like **Cursor** to prototype ideas. He refers to this as vibe coding, the ability to articulate a vision to an AI and receive a working prototype in minutes, rather than waiting weeks for an engineering team to interpret a brief.

## **Branding as a Strategic Moat**

A significant portion of **Klarna**’s success is attributed to its unconventional branding, which moved away from classic fintech blue to a pink, aesthetic heavy identity.

### **The Smooth Campaign**

* **Origin:** The concept was developed with the help of [Siemiatkowski](https://www.linkedin.com/in/sebastian-siemiatkowski-768977/)’s wife, [Nina](https://www.linkedin.com/in/nsunden/), and CMO [David Sandstrom](https://se.linkedin.com/in/davidsandstrom). It focused on the sensory and emotional response to the brand rather than the utility of payments.  
* **The Fish Ad:** The iconic fish climbing a ladder and sloth in a pool advertisements were designed to be provocative and edgy, creating a smooth identity that went viral and became a meme.  
* **Celebrity Integration:** Partnerships with [Snoop Dogg](https://en.wikipedia.org/wiki/Snoop_Dogg), [Lady Gaga](https://en.wikipedia.org/wiki/Lady_Gaga), and [Paris Hilton](https://en.wikipedia.org/wiki/Paris_Hilton) were used to communicate that **Klarna** is a relaxed and forthcoming brand compared to people in suits in marble offices.

### **Future Creative Direction**

[Siemiatkowski](https://www.linkedin.com/in/sebastian-siemiatkowski-768977/) expressed a desire to return to the roots of the fish, moving away from traditional commercials (like Super Bowl spots) and back toward unexpected, artsy, and edgy marketing to maintain its differentiation as the company prepares for its IPO.

## **Macroeconomic Resilience and Risk**

[Siemiatkowski](https://www.linkedin.com/in/sebastian-siemiatkowski-768977/) argues that the BNPL model is inherently more resilient in a recession than traditional credit card banking.

* **Agility in Underwriting:** Because **Klarna**’s loans are small (average 80-100) and short term (4-6 weeks), the company can refresh its entire balance sheet with new underwriting standards within 60 days of a market shift. Traditional banks are stuck with long term debt that cannot be quickly mitigated.  
* **Fighting Fire with Fire:** While critics suggest BNPL encourages debt, [Siemiatkowski](https://www.linkedin.com/in/sebastian-siemiatkowski-768977/) frames it as healthier credit, noting that many users use it to avoid the 20-30% interest rates associated with revolving credit card debt.  
* **The White Collar Employment Challenge:** [Siemiatkowski](https://www.linkedin.com/in/sebastian-siemiatkowski-768977/) warns of a turbulent societal shift. He notes that AI is primarily impacting headquarters and white collar jobs (translators, coders, etc.) rather than factory floors, which may lead to short term economic friction despite long term productivity gains.

## **Leadership Philosophy: Customer Obsession**

[Siemiatkowski](https://www.linkedin.com/in/sebastian-siemiatkowski-768977/) cites [Jamie Dimon](https://www.linkedin.com/in/jamiedimon) (**JPMorgan**) and [Ian MacLaurin](https://en.wikipedia.org/wiki/Ian_MacLaurin,_Baron_MacLaurin_of_Knebworth) (**Tesco**) as influences regarding customer obsession.

* **Direct Engagement:** He advocates for executives to spend more time calling customers and reviewing user sessions.  
* **Avoiding Internal Echo Chambers:** [Siemiatkowski](https://www.linkedin.com/in/sebastian-siemiatkowski-768977/) notes that internal opinions on what customers want are often proven wrong the moment an actual customer is called on the phone.  
* **Transparency:** He believes in being transparent and honest about the realities of AI driven downsizing, rather than offering generic corporate platitudes.

## **Key Quotes**

"Investors basically gave us credit for the fact... that building the next generation of a retail bank was going to come true... and then suddenly investors said well maybe, but not really right now."

"I’ve been vibe coding my whole life... the only difference is now I’m sitting with a computer and I’m doing it with AI and it’s coming back with the prototype in 20 minutes."

"We’re fighting credit with credit. We’re fighting fire with fire... and this is a healthier form of credit."

# 2025-09-15

# **Activist Turnaround and Future Vision for Opendoor**

## **Executive Summary**

The following briefing outlines the strategic turnaround and future trajectory of **Opendoor** (OPEN), as detailed by [Keith Rabois](https://www.linkedin.com/in/keith). The company is currently undergoing a significant activist-led transformation centered on a complete leadership overhaul and a fundamental restructuring of its cost basis.

**Critical Takeaways:**

* **Leadership Centrality:** The turnaround is predicated on the appointment of a new CEO, [Kaz Nejatian](https://ca.linkedin.com/in/kasranejatian), who brings a founder mentality and a track record of radical operational efficiency from **Shopify**.  
* **Operational Restructuring:** The primary objective is to transition from a bloated organization of 1,400 employees to a lean, technology driven entity of 200-300 staff.  
* **Fixed Cost Discipline:** A historical failure to maintain low fixed costs left the company vulnerable to interest rate cycles, the new mandate is to prioritize variable costs to ensure resilience in both high and low volume markets.  
* **Product Innovation via AI:** After a five year stagnation in product development, the company aims to use AI to replace human heavy processes, aiming for instant transactions for both buyers and sellers.  
* **Market Opportunity:** **Opendoor** targets the middle of the bell curve (83% of U.S. homes) within a $289 trillion asset class that has seen minimal technological innovation in 30 years.

## **The Philosophy of Leadership and Talent**

The turnaround strategy is rooted in the belief that the CEO represents 99% of everything that matters. The success or failure of the company is viewed as a direct consequence of the density of talent marshaled by leadership.

* **The Kaz Mandate:** The new CEO was selected for his rare combination of product innovation (formerly running product and operations at **Shopify**) and rigorous analytical discipline.  
* **Speed as a Variable:** The leadership philosophy dictates that the only speed is faster. The goal is to execute restructuring, product innovation, and recruitment in parallel rather than sequentially.  
* **The Founder Mentality:** The strategy requires a leader who operates with 24/7 urgency and refuses to accept excuses for operational delays.

## **Historical Context and Structural Failures**

Despite reaching a $20 billion market cap and generating $500 million to $1 billion in free cash flow post IPO in 2020, **Opendoor** failed to build a sustainable foundation for shifting macroeconomic climates.

### **The Fixed Cost Trap**

The company ignored early warnings (notably from [Vinod Khosla](https://en.wikipedia.org/wiki/Vinod_Khosla)) to keep fixed costs low. When the **Federal Reserve** enacted unprecedented interest rate hikes, **Opendoor**’s cost structure remained aligned with a peak market (6 million annual transactions) rather than a corrected market (4 million annual transactions).

### **Comparison of Operational Risks**

| Feature | Opendoor (Pre-Turnaround) | Airbnb (COVID Comparison) |
| :---- | :---- | :---- |
| **Risk Type** | Predictable Cyclicality | Black Swan Event |
| **Failure Point** | Bloated G\&A and high fixed costs. | Sudden disappearance of contribution profit. |
| **Resilience** | Lacked a model that works in low seasons. | Saved by clever financing (**Silverlake** note). |

## **The Turnaround Playbook: Efficiency and G\&A Reduction**

A core component of the activist intervention is a radical reduction in General and Administrative (G\&A) expenses.

* **Headcount Rationalization:** The document suggests the current 1,400 employee count is excessive for a technology focused business. The target state is a specialized team of 200-300 employees.  
* **The Shopify Model:** The new CEO previously reduced **Shopify**’s G\&A as a fraction of revenue from 14% to 4%, with a long term target of 1%. **Opendoor** aims to replicate this trajectory to survive real estate’s inevitable decadal cycles.  
* **Activists' Role:** [Keith Rabois](https://www.linkedin.com/in/keith) and co-founder [Eric Wu](https://www.linkedin.com/in/ericwu01/) initiated this project on July 16th, deciding to fix the company and present the board with a preselected, non-negotiable CEO candidate.

## **Future Product Strategy and AI Integration**

The next phase of **Opendoor** focuses on eliminating the friction and pain of residential real estate transactions through technological substitution.

### **AI as a Magic Wand**

The strategy views AI as the biggest unlock for the business.

* **Human Substitution:** Using technology to replace roles traditionally held by doctors, lawyers, and specifically, real estate agents.  
* **Automated Pricing:** Refining the ability to price homes automatically to facilitate 3 minute sales and 3 day payouts.

### **Innovation in Affordability and Financing**

To combat high mortgage rates, the company is looking toward financing innovations:

* **Assumable Mortgages:** Leveraging the fact that 30% of U.S. homes have mortgages that are legally permissible to assume (often at lower 1-3% rates).  
* **Instant Underwriting:** Developing a "Buy It Now" button for homes, enabling a 30 second purchase process with guaranteed instant mortgages.  
* **Lease to Own:** Exploring mainstream lease to own products to allow buyers to test neighborhoods before committing to a purchase.

## **Market Dynamics and the Pain of the Status Quo**

The residential real estate market is characterized by extreme inefficiency that **Opendoor** seeks to exploit.

* **The Friction of Selling:** In the traditional U.S. market, homes sit for an average of 80 days. Even after an offer is received, 20% of those offers fail to close.  
* **The Trade-In Model:** **Opendoor** aims to make selling a home as seamless as trading in a car. This solves the contingent offer dilemma where buyers cannot purchase a new home until their previous one clears its mortgage.  
* **Target Demographic:** The company focuses on the middle of the bell curve, pricing 83% of standard homes. It avoids atypical or luxury markets (like high end New York or Miami properties) that fall outside standard deviations.

## **Geographical and Regulatory Shift**

The broader context of the turnaround involves a shift in geographical focus and a more proactive engagement with the regulatory environment in Washington D.C.

* **Office Strategy:** The company plans to move away from a distributed model to having one or two key in-person offices, with Toronto and Miami cited as primary candidates.  
* **The D.C. Pivot:** Successful entrepreneurs are increasingly spending time in Washington D.C. The current environment is described as pro-American and receptive to innovations that contribute to GDP growth, productivity, and national security.  
* **New York as a Hub:** New York is highlighted as a critical base for early stage investment and as a logistical midpoint between Miami and D.C. for rapid transit (specifically via helicopter or train).

# 2025-09-19

# **Keith Rabois: Lessons on Talent, Investing, and Organizational Culture**

## **Executive Summary**

This document synthesizes key insights from [Keith Rabois](https://www.linkedin.com/in/keith) regarding his investment philosophy, strategies for identifying high potential talent, the mechanics of high performance company culture, and his personal frameworks for professional success.

The core of [Keith Rabois](https://www.linkedin.com/in/keith) professional philosophy rests on the principle of comparative advantage, the idea that individuals and companies should strive not just to be the best, but to be the only in their respective fields. [Rabois](https://www.linkedin.com/in/keith) identifies successful entrepreneurs as those with a non-zero chance of changing the world, typically possessing either a singular, world-class trait or a rare confluence of contrasting attributes (e.g., being both highly analytical and extremely bold).

Organizationally, [Rabois](https://www.linkedin.com/in/keith) argues that successful startups must operate as cults with a unique, correct view of the world, supported by an Olympian work ethic. He emphasizes the role of a Venture Capitalist (VC) as a consigliere to founders, tasked with distilling complex problems into actionable frameworks, such as his Barrels and Ammunition theory of scaling. Ultimately, his approach combines rigorous intellectual curiosity with a belief that heroic effort is the necessary precursor to building an automated, high output business machine.

## **Talent Identification and Mentorship**

**Rabois** views talent identification as the foundation of both investing and mentoring. He looks for individuals who sit at the extreme ends of the bell curve.

### **Criteria for Exceptional Talent**

* **The Non-Zero Chance:** The primary filter for investment or mentorship is whether the individual has a non-zero chance of transforming an industry or the world.  
* **The One Percent Trait:** Individuals should be in the top 1 to 10 basis points in a specific, world-class trait, such as tenacity, intelligence, or sales ability.  
* **The Confluence of Traits:** Magic often happens at the intersection of rare, often contradictory traits.  
  * [Eric Wu](https://www.linkedin.com/in/ericwu01/): Bold and ambitious while remaining rigorously analytical.  
  * [Max Levchin](https://www.linkedin.com/in/maxlevchin): A first rate technologist who is also a first rate business strategist.

### **Strategies for Identifying Talent**

* **Content as Proxy:** [Rabois](https://www.linkedin.com/in/keith) identifies talent through unconventional channels, such as reading high quality **Quora** posts or social media content, which can reveal a person’s confluence of interesting ideas.  
* **Physical Presence and Personal Networks:** While technology can help scale identification, [Rabois](https://www.linkedin.com/in/keith) believes assessment is most effective in person. He has used personal activities, such as his soccer team, as a magnet for hiring.  
* **The Node Theory:** Talent tends to cluster. If you find one node (an exceptional person), the five people they spend the most time with are likely also highly talented.

## **Professional Strategy: The Only Framework**

[Rabois](https://www.linkedin.com/in/keith) emphasizes that successful individuals must define their own course rather than competing on common ground.

* **Be the Only, Not the Best:** Quoting [Jerry Garcia](https://en.wikipedia.org/wiki/Jerry_Garcia) (via [Pat Riley](https://en.wikipedia.org/wiki/Pat_Riley)), [Rabois](https://www.linkedin.com/in/keith) argues: "You don't want to be the best in the world at what you do, you want to be the only one who does what you do."  
* **Doubling Down:** Once a comparative advantage is identified, individuals must double, triple, and quadruple down on it to ensure there are no substitutes for their specific role or skill set.

## **Organizational Management and Scaling**

[Rabois](https://www.linkedin.com/in/keith) utilizes conceptual frameworks to simplify complex operational challenges for founders.

### **The Barrels and Ammunition Concept**

Founders often complain that hiring more people leads to lower productivity. [Rabois](https://www.linkedin.com/in/keith) explains this through the Barrels and Ammunition framework:

* **Ammunition:** New employees/engineers.  
* **Barrels:** Leaders who can take a project from concept to completion.  
* **The Bottleneck:** If you increase ammunition without increasing the number of barrels, you simply stack ammunition behind the same number of drivers, leading to frustration and stagnation.

### **The Startup as a Cult**

[Rabois](https://www.linkedin.com/in/keith) adopts [Peter Thiel](https://www.linkedin.com/in/peterthiel)’s view that every successful company is essentially a cult.

* **Definition:** A cult in this context is a group that holds a view of the world that is different from normal people, but is ultimately proven correct.  
* **Components:** A company must have a secret regarding the market, the product, and people, stitched together into a rigid set of beliefs.

### **The Role of Heroic Effort**

* **Building the Machine:** Startups require heroic effort for the first four to seven years to construct a machine. Once the machine is built, it should be robust enough that idiots can run it (referencing [Warren Buffett](https://en.wikipedia.org/wiki/Warren_Buffett)).  
* **Work Ethic:** [Rabois](https://www.linkedin.com/in/keith) dismisses 996 (9 a.m. to 9 p.m., six days a week) as lazy compared to the intensity required at companies like **PayPal** or in high stakes legal careers. He advocates for an Olympian work ethic.

## **Communication and the VC Role**

[Rabois](https://www.linkedin.com/in/keith) defines the primary role of a VC or executive as a consigliere.

* **Actionable Frameworks:** The goal is to simplify a complicated set of facts into an actionable framework.  
* **Responsibility of the Communicator:** [Rabois](https://www.linkedin.com/in/keith) uses a basketball metaphor: it is the passer’s responsibility to ensure the recipient catches the ball. If the recipient fumbles, the communicator failed to account for the recipient's specific attributes and needs.

## **Personal Philosophy and High Performance**

[Rabois](https://www.linkedin.com/in/keith)’ personal habits are geared toward maintaining high energy and intellectual edge.

### **Health and Energy**

* **Prioritizing Sleep:** [Rabois](https://www.linkedin.com/in/keith) considers sleep the most important factor for being happy, healthy, and wealthy.  
* **The Diet Coke Realization:** Despite a long term addiction to Diet Coke (8-10 cans a day), [Rabois](https://www.linkedin.com/in/keith) quit cold turkey after research suggested it could trigger insulin resistance similar to sugar.  
* **Stress as a Positive:** He advocates for the upside of stress, arguing that embracing high-stress environments leads to better health and success.

### **Intellectual Curiosity**

* **The Encyclopedia Approach:** [Rabois](https://www.linkedin.com/in/keith)’ drive stems from deep intellectual curiosity, as a child, he read the entire World Book Encyclopedia cover to cover.  
* **The Benefit of VC:** He views Venture Capital as the ultimate job for the intellectually curious, as it pays the professional to learn about cutting edge technologies (AI, batteries, etc.) daily.

### **Recommended Reading for Founders**

[Rabois](https://www.linkedin.com/in/keith) identifies three canonical books for professional development:

| Book Title | Author | Key Lesson |
| :---- | :---- | :---- |
| The Upside of Stress | [Kelly McGonigal](https://en.wikipedia.org/wiki/Kelly_McGonigal) | Embracing stress for health and happiness. |
| High Output Management | [Andy Grove](https://en.wikipedia.org/wiki/Andrew_Grove) | The foundational text for business operations. |
| The Score Takes Care of Itself | [Bill Walsh](https://en.wikipedia.org/wiki/Bill_Walsh) | How to build a successful organization through standards. |

## **Historical Perspective: The PayPal Mafia and eBay**

[Rabois](https://www.linkedin.com/in/keith) reflects on the **PayPal** Mafia and the lessons learned from their post acquisition experience.

* **Comparative Advantage:** The various members of the **PayPal** Mafia ([Peter Thiel](https://www.linkedin.com/in/peterthiel), [Max Levchin](https://www.linkedin.com/in/maxlevchin), [David Sacks](https://www.linkedin.com/in/davidoliversacks), [Reid Hoffman](https://www.linkedin.com/in/reidhoffman)) succeeded because they each figured out how they wanted to compete with the rest of the world individually.  
* **The Failure of eBay:** [Rabois](https://www.linkedin.com/in/keith) notes that **eBay** failed to recognize the threat of **Google** and **Amazon** because they relied on management consultants (specifically **Bane**) rather than intuitive leadership. He characterizes the management at the time as idiots who were protected for a decade, only by the strength of their network effect.

# 2025-10-03

# **AI Supercycle: Vibe Coding, Valuations, and the 100x Opportunity**

## **Executive Summary**

The current technological shift driven by Artificial Intelligence (AI) represents a 100x opportunity, significantly surpassing the 10x disruptions seen during the PC, Web, and Mobile eras. This transformation is fueled by two primary forces: the transition to conversational, natural language interfaces (democratizing programming for 8 billion people) and the ability of machines to reason, plan, and take action.

While the market is experiencing a supercycle characterized by high valuations and billion dollar seed rounds, a clear distinction is emerging between vibe revenue (experimental or low margin) and durable, high margin revenue. The economic impact is projected to be massive, with AI potentially performing 10% to 20% of the work currently handled by the $30 trillion global knowledge worker market, creating a $3 to $6 trillion opportunity over the next five to seven years. Success in this era requires a shift from traditional SaaS subscription models to consumption based pricing and a relentless focus on AI teammates that amplify human capability.

## **The AI 100x Disruption**

The AI era is fundamentally different from previous technological waves due to a dual layer disruption:

* **Front-End Disruption (Conversational Interface):** For the first time, machines understand human language, removing the requirement to learn specific programming languages. This expands the potential pool of creators from 30 million developers to 8 billion people.  
* **Back-End Disruption (Intelligence and Action):** Beyond processing information, GPUs and AI technology allow machines to think, reason, plan, and, most importantly, take autonomous action.

### **Comparison of Technological Eras**

| Era | Primary Innovation | Impact Scale |
| :---- | :---- | :---- |
| **PC Era** | Computing brought to every desktop | 10x |
| **Web Era** | Information consumption democratized | 10x |
| **Cloud/Mobile** | Back-end and front-end infrastructure shifts | 10x |
| **AI Era** | Conversational interface \+ Machine reasoning/action | 100x |

## **The Vibe Economy and Vibe Coding**

The term Vibe Coding refers to the shift where natural language prompts are used to build applications and websites. This transition suggests the emergence of a Vibe Economy or Vibe Era, characterized by:

* **Democratization of Expertise:** Knowledge and technical expertise are no longer gatekept by those who can program. AI acts as an equalizer, allowing any individual to become a creator or entrepreneur.  
* **Vibe Ops:** A predicted evolution of operations where the vibe or intent drives technical execution.  
* **High Velocity Creation:** Product development cycles are accelerating. Where consumer electronics previously updated annually, AI driven innovation could lead to new product releases every three to six months.

## **The Collaborative Intelligence Stack**

The current technology landscape is structured into several layers, with value currently concentrated at the bottom but expected to migrate to the top.

1. **Hardware Layer:** Semiconductors (e.g., **Nvidia**) and networking/interconnect technologies (e.g., **Broadcom**, optical interconnects).  
2. **Brain/Model Layer:** Foundational model companies (e.g., **OpenAI**, **Anthropic**).  
3. **Data Layer:** Bringing proprietary data to the models and hardware.  
4. **Middleware and Tooling:** The plumbing required to build on the model layer.  
5. **Intelligent Applications:** Software with AI as a core ingredient to solve specific user problems.  
6. **AI Teammates (Agentic Technology):** Digital companions that work alongside humans to offload tasks. This is considered the most exciting layer, targeting the $30 trillion global spend on knowledge workers.

## **Market Dynamics and Valuation Trends**

The AI sector is currently seeing a significant premium in capital raising and valuation compared to non AI companies.

* **Capital Concentration:** In the first half of 2025, approximately 67% of all venture dollars went into AI companies. This is expected to rise to 90% within a year.  
* **Valuation Inflation:** AI native companies at the Series A stage saw 30.9% higher valuations and secured 33% more capital than their peers.  
* **The Billion Dollar Seed Phenomenon:** There is growing concern regarding the problem of riches where seed-stage valuations reach $300 million or more, often before fundamental progress is established.  
* **Growth Benchmarks:** In the traditional SaaS era, growing from $1M to $3M in revenue was considered strong. In the AI era, top decile companies (like **Lovable** or **Cursor** category leaders) are expected to go from $1M to $10M or even $1M to $100M within a year, particularly if they employ a bottoms up, product led growth strategy.

## **Evolving Business Models: From SaaS to Consumption**

The AI era necessitates a departure from the per user, per month subscription model that defined the SaaS era.

### **Consumption and Outcome-Based Pricing**

Because AI companies often rely on third-party models with high inference costs (charged per token), a fixed fee subscription can lead to negative gross margins. In such cases, the most active (and therefore best) customers become the most unprofitable. To build a durable business, companies are moving toward:

* **Consumption-Based Pricing:** Charging for the actual resources used.  
* **Outcome-Based Pricing:** Charging based on the specific task completed or the value delivered.

### **Real Revenue vs. Vibe Revenue**

Durable revenue is defined by three factors:

1. **Real Customers:** Avoiding incubation loops where startups only sell to other startups within the same incubator.  
2. **High Margins:** Moving away from the 15-20% (or negative) margins seen in early coding agents toward the 70-90% margins typical of healthy software businesses.  
3. **Repeatability:** Revenue that is not conditional or experimental but recurring and core to the customer's operations.

## **Human Centric Investment Philosophy**

Despite the technological shift, the fundamentals of building winning companies remain rooted in human capital.

### **Key Founder Traits**

* **High EQ over IQ:** While intelligence is a baseline, emotional intelligence and being secure in one's skin are critical for building teams and navigating the wall of entrepreneurship.  
* **Authenticity and Mission:** Founders must be authentic and mission oriented rather than seeking a quick buck.  
* **We vs. I:** Company building is a team sport. Investors look for leaders who prioritize the company first, the team second, and themselves third.  
* **Persistence:** The ability to go through any wall and refuse to take no for an answer.

### **The Role of Humans in an AI World**

The Superintelligence era is viewed not as a threat of human obsolescence, but as an era of Collaborative Intelligence. AI serves as a horse and the human as the jockey.

* **Democratization of Intelligence:** AI acts as a digital assistant for doctors, lawyers, and nurses, addressing labor shortages and expanding the capabilities of professionals.  
* **The Consumer Mandate:** The primary advice for individuals in this era is to consume this thing before it consumes you, adopting the technology to amplify personal and professional output.

# 2025-10-05-1

# **Reindustrialization Frontier: Air Mobility, AI Manufacturing, and Kinetic Defense**

## **Executive Summary**

The current landscape of American industry is undergoing a radical shift driven by frontier tech companies focused on vertical integration, the digital transformation of manufacturing, and the application of AI to physical systems. This document explores three pivotal entities at the forefront of this movement: **Joby Aviation**, **Dirac, Inc.** and **Allen Control Systems** (ACS).

Key takeaways from the current industrial trend include:

* **Vertical Integration as Necessity:** Companies are moving away from traditional supply chains, choosing to design and manufacture their own components (PCBs, power electronics, and composite parts) because the required technology often does not exist on the open market.  
* **The Drone Centric Defense Shift:** Modern warfare is transitioning toward robot on robot conflict. There is a growing consensus that electronic warfare (jamming) is unsustainable, leading to the development of AI driven kinetic defeat systems (automated machine guns).  
* **Digitalization of Tribal Knowledge:** To combat the aging out of the American industrial workforce, new platforms are being built to automate production planning and capture decades of manufacturing expertise into 3D, animated, context-aware instructions.  
* **Strategic Capital and Partnerships:** Major automotive players like **Toyota** are investing heavily ($500 million) in electric aviation, while the public market is becoming a viable path for capital intensive frontier hardware startups earlier in their life cycles.

## **Advanced Aerial Mobility: Joby Aviation**

**Joby Aviation** is positioning itself as the primary provider of electric vertical takeoff and landing (eVTOL) aircraft, aiming to transition from a R\&D focused startup to a global air taxi operator.

### **Manufacturing and Expansion**

**Joby** is aggressively expanding its Made in America footprint to meet certification and production goals:

* **Capacity Doubling:** The company is doubling capacity at its pilot manufacturing site in Marina, California.  
* **Ohio Expansion:** **Joby** has acquired and is refurbishing a facility in Ohio to produce parts for certified aircraft.  
* **Vertical Integration:** **Joby** manufactures nearly all its own components. This philosophy stems from the fact that specialized parts for revolutionary electric aircraft were simply unavailable for purchase.

### **Technology and Infrastructure**

A core pillar of **Joby**'s strategy is community acceptance through noise reduction:

* **Acoustics:** The aircraft is designed to be silent when overhead (1,500 ft) and quiet enough at 300 ft to hold a conversation without raising voices.  
* **The Vertiport Model:** **Joby** utilizes a multimodal car-**Joby**\-car or car-**Joby**\-walk system. In partnership with **Uber** and **Delta**, passengers use a backend software platform to match with shared rides for optimized economics.  
* **International Operations:** **Joby** has signed as the exclusive air taxi provider for Dubai, recently completing stress testing in 110°F (43°C) desert conditions.

## **Context-Aware Production: Dirac, Inc.**

**Dirac** is addressing the degrading industrial base of the United States by modernizing how complex machinery is assembled.

### **The Problem: Archaic Infrastructure**

The manufacturing sector currently relies on tribal knowledge, expertise held in the heads of aging workers, and outdated paper based work instructions.

* **Retirement Risk:** As the workforce ages out, their expertise disappears, leading to facility shutdowns or product cancellations.  
* **Inefficiency:** Standard instructions often resemble thick paper binders with **Microsoft** Word templates, which are manual to create and difficult for new talent to follow.

### **The Solution: Build OS**

**Dirac**’s Build OS platform automates the creation of production plans:

* **Automated Sequencing:** The software takes a CAD file or 3D model as input and automatically determines the assembly sequence.  
* **3D Animation:** It generates 3D animated instructions, which significantly reduce the high-skill labor requirements for new hires.  
* **The 80/20 Rule:** **Dirac** automates 80% of the instruction making grunt work, while the remaining 20% captures the human rule of thumb tribal knowledge, acting as a data aggregation platform for specialized expertise.

## **Kinetic Counter UAS: Allen Control Systems (ACS)**

**Allen Control Systems** is a defense contractor focused on the drone warfare future, specifically through the development of the Bullfrog system.

### **Kinetic Defeat vs. Electronic Warfare**

**Allen Control Systems** argues that traditional countermeasures are becoming obsolete:

* **The Failure of Jamming:** As drones begin to incorporate AI, they can no longer be jammed or neutralized via electronic warfare (EW).  
* **Reliability of Ballistics:** Drones cannot be easily armored against bullets. **Allen Control Systems** focuses on kinetic defeat because bullets are cheap, plentiful, and effective.

### **The Bullfrog System**

* **Full-Stack Turrets:** **Allen Control Systems** is vertically integrated, cutting its own steel and designing its own PCBs and power electronics to ensure the precision required to hit high speed drones.  
* **AI Integration:** The system uses AI not for autonomous decision making in the AGI sense, but for high speed precision robotics and safety features like bounding boxes to prevent friendly fire.  
* **Market Scale:** The company views Bullfrog as a replacement for every vehicle mounted gun in modern militaries, aiming for a lateral kill metric where the system neutralizes top-speed drones with minimal ammunition.

## **Strategic Comparison of Industrial Key Players**

| Feature | Joby Aviation | Dirac, Inc. | Allen Control Systems |
| :---- | :---- | :---- | :---- |
| **Core Product** | eVTOL Air Taxi | Build OS (Manufacturing Software) | Bullfrog (AI Machine Gun) |
| **Key Philosophy** | Vertical Integration (Up & Down) | Context-Aware Planning | Kinetic Defeat for Drones |
| **Market Target** | Urban Transit / Dubai / Airlines | Mid-market OEMs | Global Defense / Militaries |
| **Key Investors** | **Toyota** ($500M), **Uber**, **Delta** | **Founders Fund, Siemens** | **Craft Ventures**, **Inspired Capital** |
| **Location** | California and Ohio | New York (Empire State Building) | Austin, TX |

## **Overarching Themes in the Reindustrialize Movement**

### **The Role of Data and AI**

Across all three sectors, AI is being utilized for specific, high utility applications rather than general intelligence:

* **Joby:** Utilizes AI agents for internal operations and gigabytes per flight data processing via **Databricks** to monitor safety and manufacturing.  
* **Dirac:** Uses AI to condense structured information from CAD files into usable shop floor instructions.  
* **Allen Control Systems:** Uses AI to drive precision robotics to ensure a bullet lands exactly where intended on a moving target.

### **The Urgency of Talent**

There is a noted talent gap in American manufacturing. Leaders in this space are calling for a cultural shift:

* **Engagement:** Modernizing the tools (using 3D animations and tablets instead of paper) is seen as a way to make manufacturing careers fun and attractive to younger workers.  
* **The Mission:** Defense and aerospace startups are leveraging the Greatest Weapon System or Saving the West narratives to recruit top-tier engineering talent away from traditional Big Tech.

### **Capital Intensity**

Building frontier tech is recognized as a capital intensive endeavor. **Joby**'s decision to go public via SPAC (**Reinvent**) was a strategic move to access the capital necessary for vertical integration. Similarly, **Allen Control Systems** has already raised $43 million to support the heavy machining and engineering costs associated with hardware development.

# 2025-10-05-2

# **Epirus and Galvanick: The Future of Defense and Cyber-Physical Security** 

## **Executive Summary**

The landscape of national security is undergoing a fundamental shift characterized by the convergence of digital systems and physical reality, a transition often referred to as the Sixth Domain of warfare. This document synthesizes insights from [Andy Lowry](https://www.linkedin.com/in/andylowery) (CEO of **Epirus**) and [Joshua Steinman](https://www.linkedin.com/in/jmsteinman) (Founder of **Galvanick**) regarding the critical vulnerabilities and technological imperatives facing the United States.

**Critical Takeaways:**

* **Physical Cyber Convergence:** Cyberattacks are no longer confined to software and networks, they now manifest in the physical realm through drones, robotic systems, and industrial control systems (ICS).  
* **The Neo-Prime Model:** Modern defense companies are moving away from traditional waterfall procurement processes toward rapid, iterative product development models used in Silicon Valley to bridge capability gaps.  
* **The OT Security Vacuum:** While IT security is a multibillion dollar industry, Operational Technology (OT) security, protecting the systems that manage water, power, and manufacturing, remains dangerously underdeveloped.  
* **Reindustrialization Mandate:** The U.S. faces significant manufacturing disparities, particularly against China, necessitating a revitalization of domestic supply chains for high volume components like microwave amplifiers and microprocessors.  
* **Asymmetric Threats:** Adversaries like China (via actors like Salt Typhoon and Volt Typhoon) have prepositioned themselves on critical U.S. infrastructure, ready to disrupt essential services at a time of their choosing.

## **The Sixth Domain: Convergence of Cyber and Physical Warfare**

The traditional domains of land, sea, air, space, and cyber have evolved. The Sixth Domain represents the point where digital attacks result in physical destruction or control.

* **Physical Manifestation of Cyber:** Modern weaponry consists of computers that fly (drones), boats, and robotic infantry. Because these systems are built on common system on a chip (SoC) architectures (**Qualcomm**, **Intel**, **Nvidia**), they are susceptible to cyber interference weaponized as electromagnetic energy.  
* **One to Many Defense:** Traditional defense systems (the OODA loop) are designed for one to one threats. Modern threats, such as drone swarms, require defenses that can repel thousands of simultaneous attacks equally, much like antivirus software handles multiple digital threats.  
* **Industrial Sabotage:** Real-world examples include the remote takeover of Iranian steel mills, where attackers manipulated gantry cranes to pour molten metal onto the factory floor, effectively ruining the industry for years.

## **Epirus: Directed Energy and the Neo-Prime Approach**

**Epirus** focuses on weaponizing electromagnetic interference to protect against the proliferation of low cost consumer electronics utilized in warfare.

### **Technological Foundation**

**Epirus** utilizes Gallium Nitride (GaN) Phased Arrays to create a force field that disrupts the control circuits of drones and other robotic systems. This technology originated from the Next Generation Jammer project at **Raytheon** but was adapted for base and vehicle protection.

### **Product Evolution: Generation 1 vs. Generation 2**

**Epirus** has moved through rapid prototyping stages (EVT, DVT, PVT) to iterate on its defense systems based on data from overseas deployments.

| Feature | Generation 1 | Generation 2 |
| :---- | :---- | :---- |
| **Development Focus** | Initial prototype and deployment | Mission capable, production ready |
| **Range** | Baseline | 2.5x increase in range |
| **Form Factor** | 10ft x 10ft box | Identical size to Gen 1 |
| **Key Capability** | Electromagnetic disruption | Extended protection arc, accounts for tumbling motion of aircraft |

### **The Neo-Prime Philosophy**

Unlike traditional primes (e.g., **Raytheon**), neo-primes (e.g., **Epirus**, **Anduril**, **Palantir**) operate as product companies. They identify capability gaps rather than waiting for formal government requirements, allowing them to iterate faster and use independent capital to prove technological viability.

## **Galvanick: Securing Operational Technology (OT)**

**Galvanick** addresses the security of the industrial base, which [Joshua Steinman](https://www.linkedin.com/in/jmsteinman) identifies as the most vulnerable point in the defense supply chain.

### **The IT/OT Divide**

There is a massive disparity between Information Technology (IT) security and Operational Technology (OT) security:

* **IT Security:** Well funded, standardized, and protected by multibillion dollar entities like **CrowdStrike**.  
* **OT Security:** Nearly zero, most industrial networks move data unencrypted. Equipment is designed to execute any instruction it receives without verifying the source.

### **Galvanick’s Solution**

The company provides a monitoring platform that correlates data from industrial facilities in real time.

* **Automated Investigation:** Replicates the work of a team of analysts, reducing investigation times from weeks or months to 2-5 minutes.  
* **Visibility:** Detects unauthorized hardware (e.g., a strange laptop plugged into a CNC machine) and malicious firmware updates that could lead to physical catastrophic failure.  
* **Human Capital Gap:** There are fewer than 10,000 Americans trained in OT cybersecurity, necessitating automated, software driven solutions.

## **Strategic Challenges and Reindustrialization**

A recurring theme in the discourse is the decay of the American industrial base and the resulting national security risks.

### **Manufacturing Disparities**

The scale of production in China far outstrips that of the United States. While China is capable of building an estimated 60 million drones per year, the U.S. produces approximately 50,000.

### **Supply Chain Fragility**

* **Microprocessors:** It is currently impossible to buy a purely American made computer, the military must rely on foreign sourced hardware by exception.  
* **High Powered Amplifiers:** **Epirus** requires tens of thousands of microwave amplifiers. The U.S. has not maintained high volume production capacity for these components since the early 2000s.  
* **Rocket Motors:** Similar to electronics, essential components for kinetic defense (like rocket motors) face severe domestic sourcing shortages.

### **Geopolitical Friction Points**

* **China:** The most critical adversary in the cyber domain. Entities like Salt Typhoon and Volt Typhoon have prepositioned themselves within U.S. telecommunications and critical infrastructure.  
* **Taiwan:** The potential for conflict is gauged by the Taiwanese people's will to defend themselves, specifically through the procurement of resilient weapon systems and the training of a civilian militia.

## **The Role of Artificial Intelligence**

Artificial Intelligence and potentially Artificial General Intelligence (AGI) presents both a threat and an opportunity in the security sector.

* **Vulnerability Discovery:** AI is expected to cause a Cambrian explosion in the discovery of software holes. What previously took a team of humans significant time can now be scaled by AI to find new entry points into systems.  
* **Data Synthesis:** For defense, AI is used to structure and organize unique datasets from production systems, allowing for trust but verify monitoring of industrial networks.  
* **Security Clearances:** There is a debate regarding mandating security clearances for top AI employees. While advisable from a security standpoint, the legal framework (which requires a need to know tied to specific government programs) makes a broad mandate difficult to implement.

## **Institutional Insights**

### **Executive Leadership and Personnel**

Reflecting on the first [Trump](https://en.wikipedia.org/wiki/Donald_Trump) administration, [Joshua Steinman](https://www.linkedin.com/in/jmsteinman) emphasizes that personnel is the primary differentiator between success and stagnation. He describes the former President as two increments smarter than most highly intelligent people, often making chess moves that only become clear in hindsight. The focus for future administrations will be ensuring personnel are aligned with the executive program to prevent internal resistance to policy execution.

### **Performance Management**

In high-stakes environments, performance is tracked through granular, individualized metrics. At **Galvanick**, this involves maintaining an index for every hire with three to five specific annual goals, reviewed weekly to identify and remove blockers.

# 2025-10-08

# **Base Power Strategic Expansion and Series C Financing**
...
The round includes a diverse mix of growth funds, sector-specific investors, and strategic partners:
...
* **Growth:** Adding customers at a rate of 30% month over month.  
* **Revenue:** Generating millions of dollars per month.  
* **Demand:** Thousands of customers are currently on a waitlist with a multimonth backlog.  
* **Deployment Velocity:** Currently deploying approximately 20 megawatts (MW) per month, with a target of 100 MW per month by next year.  
* **The Gigawatt Goal:** The company is moving beyond megawatt scale thinking to annual gigawatt scale additions.
...
While currently focused on Texas, the company is evaluating ten other opportunities and plans to announce its first deployment outside of Texas in the coming months. Target markets include states with high solar penetration, such as:
...
# **Turing and the Race to Superintelligence**
...
## **The Strategic Evolution of Data and Research**

The AI research landscape has moved beyond simple data processing. As frontier models become more sophisticated, the data required to improve them has become significantly harder to generate.
...
| Pillar | Description |
| :---- | :---- |
| **Multimodality** | Enabling models to process and generate various types of data (text, image, video, etc.). |
| **Reasoning** | Advancing the model's ability to solve complex, multistep problems and generalize out of distribution. |
| **Tool Use** | Teaching models to interact with external software, APIs, and dashboards to execute tasks. |
| **Coding** | High level software engineering and agentic coding to automate technical workflows. |
...
This is a highly iterative process that transforms a base model into an assistant through two main methods:

* **Supervised Fine-Tuning (SFT):** Human experts provide high quality prompt and completion pairs to teach the model how to respond. This includes safety training (e.g., declining dangerous requests in chemical, biological, radioactive, or nuclear domains).  
* **Reinforcement Learning (RL):**  
  * **RLHF (Human Feedback):** Humans rank model outputs to create a reward model that favors modular, well commented, or concise responses.  
  * **Self Play / Verifiable RL:** For domains like math and coding, models learn through experiential mini world models. They engage in self play, where correct trajectories are reinforced automatically, potentially exceeding human performance limits (similar to AlphaZero’s Move 37).
...
3. **Role:** (e.g., CMO, SEO Analyst, Director of Performance Marketing).  
4. **Workflow:** (e.g., Allocating marketing budgets based on CAC/LTV analysis).

By mapping every human workflow into this matrix and generating the necessary data to train models on these specific tasks, the industry aims to automate $30 trillion worth of global knowledge work.

## **Enterprise Strategy: Proprietary Intelligence**

For Fortune 500 companies, the goal is not to use general-purpose plug and play SaaS models, but to build Proprietary Intelligence.
...
The source addresses the cultural divide between AI Doomers and Optimists.
...
Energy is identified as a primary bottleneck for AI training, with national policy directly impacting technological leadership.
...
## **Investment Evolution and Market Dynamics**

The venture capital landscape has shifted from traditional IPO exits toward more complex, long term private structures.
...
The regulatory environment is a decisive factor in the health of the startup ecosystem.

| Sector | Regulatory Need | Key Observations |
| :---- | :---- | :---- |
| **Crypto** | Statutory Clarity | The industry primarily seeks clear rules of the road that are codified into law rather than subject to shifting executive orders. |
| **AI** | National Standards | There is concern that state level initiatives (e.g., in California) could curtail national progress by setting restrictive standards. |
| **M\&A** | Exit Flexibility | Recent curtailing of M\&A activity by big tech is viewed as negative for the startup ecosystem, as it removes necessary exit paths for companies that cannot sustain themselves independently. |

## **The Monuments Project**

A private initiative is underway to build large-scale, permanent public art across major U.S. cities to inspire future generations and signal societal ambition.

* **Historical Precedent:** Past societies at their apex built large public works (e.g., Statue of Liberty, Eiffel Tower). The last major U.S. monument of this scale was Mount Rushmore, initiated in the 1920s.  
* **Scale and Materials:** Proposed works range from 15-20 feet (similar to the Atlas at Rockefeller Center) to Statue of Liberty scale. Materials being explored include bronze, marble, and carbon fiber.  
* **Philosophy of Beauty:** The goal is to create universal beauty that remains relevant for 200+ years, avoiding the perceived unattractiveness of certain postmodern architectural styles.

## **Founder Psychology and Trillion Dollar Scaling**
...
## **Brain Co: Incubating AI for Global Institutions**
...
## **Market Structures and Defensive Moats**
...
## **The Realities of AI Adoption and Technology Waves**
...
Contrary to the belief that only startups innovate, [Gil](https://www.linkedin.com/in/eladgil) notes that certain large enterprises act as early adopters and opinion leaders. He cites **Costco** and **Home Depot** as examples of companies that often adopt new HR software and benefits before younger companies do.

## **Leadership and Media Perception**
...
* **Artificial General Intelligence (AGI):** [Gil](https://www.linkedin.com/in/eladgil) declines to provide a timeline, noting that the lack of a standardized definition makes predictions meaningless.  
...
## **Revenue Drivers and Market Cycles**
...
## **Shock Absorbers and Sparring Partners**
...
# **Alfred Lin on Market Redefinition and Founder Leadership**

## **Executive Summary**

This document synthesizes key insights from [Alfred Lin](https://www.linkedin.com/in/linalfred) of **Sequoia Capital** regarding investment philosophy, the rapid evolution of the AI sector, crisis management strategies, and the fundamental principles of building enduring technology companies.
...
* **Citadel Securities:** While a market maker, it is viewed as a technology and math driven firm that uses AI and arbitrage calculations to redefine financial liquidity.

## **The AI Megatrend: Market Dynamics and Valuations**

AI is described as the largest technology megatrend of the current generation, surpassing the impact of the internet, mobile, and cloud cycles.

### **The Compression of Innovation**

The pace of change in AI is uniquely frenetic.

* **The 3 Month Cycle:** Research and papers discussed today were not relevant three months ago and likely will not be relevant three months from now.  
* **Innovation vs. Experience:** Younger founders are increasingly competitive because innovation currently outweighs traditional experience in this cycle.

### **Valuation and Market Size**

Current AI software companies are commanding a significant premium.

| Metric | AI Software Companies (H1 2025\) | Non-AI Software Companies |
| :---- | :---- | :---- |
| **Average Valuation** | $55 Million | $42 Million |
| **Premium** | \~30.9% | N/A |
...
# **Ryan Serhant on Media, AI, and the Future of Real Estate**

## **Executive Summary**

[Ryan Serhant](https://www.linkedin.com/in/ryanserhant) has transitioned from a successful individual real estate broker to the CEO of a multifaceted holding company, **Serhant Technologies**, which has facilitated over $20 billion in career sales. The core of his strategy is a fundamental reframe: the firm operates as a media and technology company that happens to sell real estate. By integrating an in-house production studio with a proprietary AI orchestration platform called S.MPLE, the organization aims to eliminate administrative inefficiencies and maximize global lead generation.
...
The business operates as a holding company, **Serhant Technologies**, which oversees several specialized subentities designed to support a national real estate footprint.
...
* **Organic Social Media:** Platforms like **YouTube** and **Instagram** are used for immediate property tours. [Serhant](https://www.linkedin.com/in/ryanserhant) emphasizes that while deals are rarely closed in DMs, the awareness engine generated through social media facilitates multimillion dollar transactions (e.g., a $38 million deal initiated via social media awareness).
...
## **AI Empowerment: The S.MPLE Platform**

The organization identifies as AI empowered rather than merely tech enabled. The flagship technology, S.MPLE, is described as an AI Chief of Staff for salespeople.
...
* **Role Focus:** He focuses exclusively on three areas: Brand, Expand, and Sell. He delegates management to entrepreneurial hires.  
  "I'm a great leader, I'm a terrible manager."
...
# **Palantir Leadership and Strategic Vision**
...
## **Strategic Mission and Sociopolitical Alignment**
...
* **Reindustrialization:** **Palantir** plays a role in reindustrialization by using tools like the Foundry Ontology to help American workers scale their productivity to match or exceed international competitors.
...
| **Maven / Hivemind** | Government/Defense AI applications. |
| **AIP** | Artificial Intelligence Platform focused on LLM orchestration. |
...
* **Skepticism of Analysts:** [Karp](https://en.wikipedia.org/wiki/Alex_Karp) describes the analyst and expert class as totally bereft of common sense and not particularly honest, largely because they cannot admit they were wrong.  
...
# **The Rise and Impact of American Dynamism**

## **Executive Summary**

The American Dynamism movement, pioneered by **Andreessen Horowitz** (**a16z**), represents a strategic pivot in venture capital toward investing in technologies that support the national interest, including defense, energy, space, and public safety. Originally launched as a practice in early 2022, the initiative has transitioned from a meme into a massive financial movement, evidenced by **a16z**’s $660 million inaugural fund and a broader $1.5 trillion commitment from **J.P. Morgan** to the category.

The core thesis of American Dynamism rests on the convergence of three factors: a revolutionary shift in technology (AI, autonomy, and computer vision), a geopolitical necessity to reduce reliance on adversaries like China for critical infrastructure, and a modernized demand from government agencies for faster, software driven solutions. By leveraging private capital to fund research and development (R\&D), startups are bypassing traditional, burdensome government procurement processes to deliver superior technological outcomes. This document examines the philosophy, structural innovations, and sector specific impacts of this burgeoning investment category.
...
## **Market Dynamics: Supply, Demand, and Capital**

The American Dynamism category is driven by a unique alignment of supply and demand factors that did not exist a decade ago.
...
| **Capital Flow** | Massive influx of private capital. **J.P. Morgan**’s $1.5 trillion commitment signals broad scale recognition of the category’s importance and potential for returns. |
...
## **Technological Impact Sectors**

AI is the primary driver of transformation across the American Dynamism portfolio, impacting infrastructure, defense, and public safety.
...
* **Computer Vision:** Projects like **Anduril**’s EagleEye (body worn headsets) and Lattice (a coordination layer for hardware) provide warfighters with unprecedented situational awareness.  
...
## **Strategic Competition and Manufacturing Independence**
...
* **Lumber:** Utilizing advanced software to transform domestic wood production to meet housing and infrastructure demands without overreliance on imports (e.g., Canada).

## **Investment Sectors and Portfolio Highlights**

The American Dynamism practice actively invests in defense, space, energy, public safety, and manufacturing. The following table highlights key portfolio companies and their strategic functions:

| Category | Company | Core Innovation / Mission |
| :---- | :---- | :---- |
| **Energy** | **Radiant Nuclear** | Developing portable, shipping container sized nuclear reactors for clean, remote energy. |
| **Energy** | **Base Power** | Enhancing grid resiliency and smoothing power curves to mitigate rising costs and disasters. |
...
| **Defense** | **Castelion** | Producing next generation, low cost hypersonic missiles at scale. |
...
| **Space** | **Northwood Space** | Improving critical ground station communications for space assets. |
...
The source highlights a brand halo approach to defense and industrial companies, traditionally seen as shadowy or enterprise only.
...
* **Non-Transactional Partnerships:** Selling to the government or major utilities is not a transactional process. It requires deep, multiyear relationships because the buyers are often betting their careers on the success of the startup's solution.
...
# **Thrive Capital: Investment Strategy and the AI Frontier**

## **Executive Summary**

This document synthesizes key insights from an analysis of **Thrive Capital**’s investment philosophy, operational tactics, and its current portfolio of generational technology companies. Led by the perspective of [Philip Clark](https://www.linkedin.com/in/philip-clark-883a41126/), a technologist and investor at **Thrive**, the analysis highlights a shift in venture capital toward extreme concentration and a leave it all on the field mentality to secure high stakes deals.
...
* **The Power Law:** The strategy reflects the reality that the top companies (e.g., The Magnificent Seven) represent a disproportionate share of market value. **Thrive** aims to invest as much capital as possible into companies on the right tail of the distribution.
...
The technical evolution of AI is categorized into distinct waves:
...
**Concept of After SaaS:** The source suggests that the industry is moving beyond the traditional SaaS model toward a substrate of productized intelligence, where intelligence is called via API or fine-tuned for specific, high value tasks.
...
* **The Vermont Strategy:** [Tusk](https://www.linkedin.com/in/btusk) suggests that states with clean energy (like Vermont's hydropower) should position themselves as data center hubs to drive economic development and tax revenue.
...
# **Inside General Catalyst’s $1.5B AI Roll-Up Strategy**
...
* **Customer Value Fund (CVF):** Designed to help companies scale quickly without excessive dilution.
...
| Feature | Software Market | Services Market |
| :---- | :---- | :---- |
| **Market Size** | \~$1 Trillion | \~$16 Trillion |
| **Historical Margins** | High (Low marginal costs) | Low to Moderate (15-20% EBITDA) |
...
3. **Content and Marketing:** Generating FAQs, investor presentations, and contracts.  
4. **Logic and Reasoning:** Basic decision making, such as insurance underwriting recommendations.

### **Criteria for Roll-Up Success**
...
# **The Department of War (DoW): Strategic Priorities and Technological Innovation**
...
* **Unified Leadership:** Despite the massive scale of the organization, the senior team (including [Scott Bessant](https://en.wikipedia.org/wiki/Scott_Bessent), [Howard Lutnick](https://en.wikipedia.org/wiki/Howard_Lutnick), Secretary [Pete Hegseth](https://en.wikipedia.org/wiki/Pete_Hegseth), and others) is reportedly operating with high camaraderie and a lack of traditional political infighting.  
...
# **Anduril Industries and the Modernization of Global Defense**

## **Executive Summary**

This document synthesizes key insights from the leadership of **Anduril Industries** regarding the current state and future trajectory of the defense industrial base. The core thesis presented is a transition from the traditional defense contractor model to a defense product company model, characterized as an **Apple** for defense. Central to this shift is the concept that the factory is the weapon, emphasizing a desperate need for the United States to reindustrialize to achieve magazine inventory advantage against near peer adversaries.
...
## **The New Defense Industrial Paradigm**
...
A critical analysis of the nearly $1 trillion US defense budget reveals significant inefficiencies:

* **Fixed Costs:** Over half the budget is allocated to personnel, facilities, and military construction.  
* **Legacy Sustainment:** A massive portion of remaining funds is spent maintaining old technology (ships, aircraft) rather than procuring new capabilities.  
* **Procurement Crisis:** As a percentage of GDP, the procurement budget is at historic lows. Leadership suggests that shifting the mix toward autonomous, cost effective systems could increase military efficiency by 200%.

## **Manufacturing as a Strategic Weapon**
...
| :---- | :---- | :---- |
| **Fury (FQ-44)** | AI powered autonomous fighter jet. | Developed from contract to flight in 556 days, designed to fly alongside manned F-35s. |
| **Ghost Shark / XL-AUV** | Extra large autonomous underwater vehicle (submarine). | Produced in Sydney, Australia, first unit off the line 30 days after production contract. |
...
## **Geopolitical Trends and Allied Expansion**
...
# **Anduril Industries and the Future of Autonomous Defense**
...
| Phase | Focus Areas | Key Characteristics |
| :---- | :---- | :---- |
| **Early Stage** | Small Drones | Low capital requirement, rapid solvability. |
| **Current Stage** | Autonomous Fighter Jets, Cruise Missiles | High complexity, hundreds of miles of range, first of class autonomy. |
| **Near Future** | High mix, Low rate Production | Flexible manufacturing capable of sustaining diverse product lines. |

## **Defense Procurement and Budget Analysis**
...
A primary driver for new defense models is the failure of traditional supply chains. Current backlogs for new Patriot missile systems are estimated at 5 to 15 years, rendering the U.S. an undependable producer for immediate needs.
...
The CEO concludes that if the trajectory of warfare continues toward autonomous, software-driven systems, the company remains undervalued despite its multibillion dollar valuation, as it is positioned to be involved in nearly every aspect of international defense.

# 2025-12-17

# **Operational Overview and R\&D Strategy of Anduril Industries**
...
The company is led by five co-founders, each managing distinct pillars of the organization. This specialized leadership structure allows the firm to balance visionary product development with complex global operations.
...
* **Anechoic Chamber:** A specialized Faraday cage environment where radio waves cannot enter or escape. It is used for testing radars, communication standards, and electronic warfare capabilities (e.g., jamming and spoofing) without interfering with local civil infrastructure like nearby [John Wayne](https://en.wikipedia.org/wiki/John_Wayne) Airport.  
* **Dev Test Area:** A facility dedicated to breaking things. It includes:  
  ...
  * **Battery Cycle Testing:** Driving batteries to failure through continuous charge/discharge cycles.
...
### **Undersea Systems: Ghost Shark (XL-AUV)**

* **Description:** A fully autonomous, robotic, extra large autonomous underwater vehicle (XL-AUV).  
...
* **Soldier Borne Compute:** Derived from the acquisition of a **Microsoft** spinout (formerly IVAS/SBCM), this program focuses on putting Lattice nodes directly on the soldier via head mounted or wrist mounted augmented reality (AR) systems.
...
# **Trae Stephens on Anduril’s Origin, Peter Thiel, and Palantir DNA**

## **Executive Summary**

This document synthesizes key insights from a discussion with [Trae Stephens](https://www.linkedin.com/in/trae-stephens-485a811), co-founder of **Anduril** and partner at **Founders Fund**, regarding the evolution of defense technology, the strategic philosophy of **Anduril**, and the current state of global competition.

The emergence of **Anduril** in 2017 marked a shift in the defense sector, transitioning from a period where defense technology was a Silicon Valley pariah to its current status as a highly popular investment area. **Anduril** distinguishes itself from traditional defense contractors by operating as a software-defined, hardware-enabled company, leveraging the organizational DNA of **Palantir**, **Tesla**, and **SpaceX**. Central to the company strategy is the concept that the factory is the weapon, necessitating a massive reindustrialization of the United States to maintain a magazine inventory advantage against adversaries like China. Furthermore, **Anduril** integrates ethical frameworks, specifically Just War Theory, to guide the development of autonomous systems designed to increase precision and remove humans from dangerous roles.

## **The Founding and Identity of Anduril**

**Anduril** was established in 2017 during a timeframe when working on defense technology was unpopular in Silicon Valley. The company was founded by [Trae Stephens](https://www.linkedin.com/in/trae-stephens-485a811), [Matt Grimm](https://www.linkedin.com/in/mttgrmm), [Brian Schimpf](https://www.linkedin.com/in/bschimpf), [Palmer Luckey](https://www.linkedin.com/in/palmer-luckey-21a16959), and [Joe Chen](https://www.crunchbase.com/person/joseph-chen).

### **Software-First Philosophy**

A common misconception is that **Anduril** is primarily a hardware company. While the firm produces physical systems across multiple domains, its core identity is rooted in software.

* **Anduril** aims to be a software-defined and hardware-enabled company, which stands in contrast to traditional primes that are hardware-defined and software-enabled.  
* The strategy focuses on shared autonomy components that can cut across sea, ground, air, and space domains.  
* The objective is to emulate the consumer profile and brand recognition of companies like **Apple**, creating products that are both effective and aesthetically evocative of human potential.

### **Organizational DNA and the Palantir Influence**

The company benefited from an unfair advantage by hiring early team members from **Palantir**, **Tesla**, and **SpaceX**.

* Three of the five co-founders came from **Palantir**, allowing **Anduril** to start from a position equivalent to **Palantir** in its tenth year regarding government relations and sales.  
  "From day one in **Anduril** we were starting from where **Palantir** was in year 10, defense as a sector is multi-domain and so you have things under the sea, things on the surface of the sea, ground vehicles, aerial vehicles, and space."  
* The company avoids traditional defense industry practices, such as relying on massive advisory boards of retired generals, a lesson learned from the experiences of **Palantir**.

## **Strategic Manufacturing and Arsenal 1**

**Anduril** is positioning itself as a new prime, focused on the scalability of production to meet the demands of modern conflict.

### **The Factory is the Weapon**

[Stephens](https://www.linkedin.com/in/trae-stephens-485a811) argues that the United States has atrophied in manufacturing capacity over the last 30 years due to offshoring and the fall of the Soviet Union.

* Reindustrialization is viewed as a strategic and geopolitical necessity.  
* The goal is to move beyond building hundreds of units, to producing tens of thousands, or hundreds of thousands of systems efficiently.  
  "I think, that's really what I was saying with the factory is the weapon, because without the factory, you have no weapons."

### **Arsenal 1 and Regional Expansion**

To address manufacturing needs, **Anduril** is developing Arsenal 1, a 5 million square foot factory campus.

* **Location:** Outside Columbus, Ohio.  
* **Selection Criteria:** Access to utility-scale power and water, a scalable labor force, and competitive state offers.  
* **Production:** The facility will ramp up production for the collaborative combat aircraft, an autonomous fighter plane.  
* **Historical Context:** Ohio is noted as the birthplace of aviation, with **GE Aviation** and **GE Aircraft** located nearby.  
* **Other Facilities:** **Anduril** operates shipyards, loitering munition assembly in Atlanta, Georgia, and headquarters in Costa Mesa, California.

## **Geopolitics and Global Competition**

The defense landscape is shaped by the need to be competitive on a global stage, particularly against the strategic initiatives of China.

### **The Challenge of China**

China is viewed as running an effective 40 year chess strategy through the Belt and Road initiative, placing the United States and its allies in a weakened position.

* **Subsidization:** China uses domestic national champions and subsidization to gain dominance.  
* **Strategic Patience:** Referencing the book: The 100-Year Marathon, [Stephens](https://www.linkedin.com/in/trae-stephens-485a811) notes that Chinese strategy historically involved buying time and hiding strength, until reaching a position of dominance.  
* **Necessity of Intervention:** There is an argument for government involvement to secure raw materials and maintain access to cutting edge semiconductors, to set global ethical standards and deter conflict.

### **Domestic Cultural Shifts**

[Stephens](https://www.linkedin.com/in/trae-stephens-485a811) observes a cultural transition in America, moving away from superficial interests toward serious endeavors.

* There is a noted rise in church attendance among Gen Z men, which contradicts predictions from a decade ago.  
* The current cultural moment is described as “a transition from slop to good questing”, where individuals seek to work on original, vocational projects that address significant problems.

## **Ethics and the Just War Theory**

**Anduril** incorporates philosophical frameworks into its internal culture, particularly regarding the intersection of AI and lethal defense.

### **Just War Theory Principles**

The company utilizes Just War Theory, developed by [St. Augustine](https://en.wikipedia.org/wiki/Augustine_of_Hippo), to evaluate the ethics of engaging in defense activities.

* **Discrimination and Just Cause:** These principles focus on the accuracy of information and ensuring actions specifically address the problem to be solved.  
* **Accuracy:** Following the peak of lethality with the atomic bomb in 1945, humanity has sought to climb back down the ladder by developing precision guided munitions to minimize collateral damage.  
* **Autonomy:** The goal of autonomous systems is to remove humans from dull, dirty, and dangerous jobs while becoming as precise as possible.

### **Philosophical Stance on Pacifism**

[Stephens](https://www.linkedin.com/in/trae-stephens-485a811) argues that pacifism is only possible within a system that maintains a monopoly on violence.
...
National security efforts protect the ability of citizens to hold anti-national security or pacifist positions.

## **Investment Strategy at Founders Fund**

[Trae Stephens](https://www.linkedin.com/in/trae-stephens-485a811) maintains a dual role at **Anduril** and **Founders Fund**, where the investment philosophy emphasizes high concentration and novel ideas.

### **Lessons from Peter Thiel**

[Stephens](https://www.linkedin.com/in/trae-stephens-485a811) highlights several critical lessons learned from working with [Peter Thiel](https://en.wikipedia.org/wiki/Peter_Thiel) at **Founders Fund**.

* **Predictive Accuracy:** [Thiel](https://en.wikipedia.org/wiki/Peter_Thiel) is noted for identifying trends years before they become mainstream, such as the political rise of [Donald Trump](https://en.wikipedia.org/wiki/Donald_Trump) or social shifts.  
* **Concentration:** Successful venture funds should have a massive amount of concentration in a few top positions rather than thousands of small investments.  
* **Zero to One:** Avoiding competition by targeting areas with no venture backed players. **Anduril** followed this by entering the defense market in 2017 when it was ignored by Silicon Valley.

### **Portfolio and Focus Areas**

The following table highlights companies and sectors of interest mentioned by [Stephens](https://www.linkedin.com/in/trae-stephens-485a811):

| Company Name | Focus Area |
| :---- | :---- |
| **Varda Space Industries** | Space based manufacturing |
| **General Matter** | Nuclear fuels |
| **Armada** | Edge compute for AI |
| **Cognition** | AI coding |
| **Forge** (rebranded to **Poetic**) | AI workbooks |

[Stephens](https://www.linkedin.com/in/trae-stephens-485a811) advises aspiring founders to avoid starting companies based on AI slop or whiteboard ideas. Instead, they should pursue original, novel ideas that keep them up at night and feel like a vocational calling.
...
* **Key Achievement (FQ-44 Fury):** The FQ-44 is the first autonomous fighter procured by the **U.S. Air Force**.  
...
## **Autonomous Systems and Collaborative Combat**

The source highlights a shift toward AI powered systems designed to augment human pilots and reduce ethical risks in high stakes environments.

### **The FQ-44 Fury Capabilities**
...
* **Utility:** It filters out biological noise (whales, fish) to identify submarines, divers in harbors, and ships not visible on radar.

## **The Role of Failure and Media Critique**
...
## **Space, Moon, and Subterranean Warfare**

The source explores the technical and strategic realities of warfare beyond Earth’s atmosphere.
...
* **Logic:** Probabilistically, more time has passed before the present than will exist in our immediate future. He suggests they could be remnants of advanced ancient Earth civilizations or travelers from the distant past who utilized gravitational time dilation to skip forward.  
...
## **Reconstituting the Arsenal of Democracy**
...
Beyond defense, [Luckey](https://www.linkedin.com/in/palmer-luckey-21a16959/) maintains interests in mechanical engineering and retrocomputing.
...
## **Lightspeed’s Investment Philosophy**
...
* **The Right Tab Test:** Partners look for ubiquity by observing what products are open on the screens of various startup offices (e.g., **Granola**, **1Password**, or **Abridge**).  
* **Live Demos:** Investment decisions often involve live, in-person product installations and walkthroughs to gauge genuine functionality and founder passion.  
...
* **Historical Influences:**  
  ...
  * [Steven Spielberg](https://en.wikipedia.org/wiki/Steven_Spielberg): Taught the importance of the antagonist, a story is only as good as its villain (e.g., Ursula, Scar, Lord Farquaad).  
...
* **Cybersecurity:** Transitioned from a consumer cybersecurity focus to broader investments like **1Password**.

## **The Intersection of Tech and Hollywood**
...
## **The Evolution of the Founders Framework**
...
## **Notable Interviews and Case Studies**
...
| [Michael Dell](https://en.wikipedia.org/wiki/Michael_Dell) | Problems as puzzles, the Infinite Game of multigenerational value. | Autobiography and 5 hour personal conversation. |
...
## **The Business of High Value Media**
...
"Most of humanity, they're not high-quality people and you should avoid them. Your job right now is very obvious: you need to build a seamless web of deserved trust with really high-quality people and talk to nobody else",  [Charlie Munger](https://en.wikipedia.org/wiki/Charlie_Munger) (as cited by [Senra](https://www.linkedin.com/in/davidsenra))

"Most people are not taken out by competition, most people sabotage themselves",  [Michael Dell](https://en.wikipedia.org/wiki/Michael_Dell) (as cited by [Senra](https://www.linkedin.com/in/davidsenra))

"Podcasting is the printing press for the spoken word",  [David Senra](https://www.linkedin.com/in/davidsenra)

"Raising money is not an accomplishment. Building a durable business is an accomplishment", [David Senra](https://www.linkedin.com/in/davidsenra)

"If you have an unhealthy mind, you're not going to reach your potential, and you can't build a great company if you're so messed up in the head",  [Brad Jacobs](https://www.linkedin.com/in/bradjacobsqxo) (as cited by [Senra](https://www.linkedin.com/in/davidsenra))

"Retirement is fatal. You need to do something. Build a body of work and a company that you're proud to tell your grandchildren about", [David Senra](https://www.linkedin.com/in/davidsenra)